import "./utils-DGqsMmdl.js";
import fs from "node:fs";
import nodePath from "node:path";
import { execSync } from "node:child_process";
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/scripts/dev/read-file.js
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/scripts/dev/write-file.js
var tool$3 = {
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/scripts/dev/list-files.js
var MAX_DEPTH = 3;
var MAX_ENTRIES = 500;
var tool$2 = {
...
function listDir(dirPath, prefix, depth, results) {
	...
	for (const entry of entries) {
		...
		if (isDir && depth < MAX_DEPTH) listDir(nodePath.join(dirPath, entry.name), prefix + "  ", depth + 1, results);
	}
}
async function run$2(args) {
	const dirPath = args.path || ".";
	const recursive = args.recursive === "true";
	const resolved = nodePath.resolve(process.cwd(), dirPath);
	try {
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/scripts/dev/search-files.js
var MAX_RESULTS = 100;
...
function walkFiles(dir, ext, files) {
	...
	for (const entry of entries) {
		...
		if (entry.isDirectory()) walkFiles(full, ext, files);
			...
			const entryExt = nodePath.extname(entry.name).toLowerCase();
...
async function run$1(args) {
	...
	const searchDir = nodePath.resolve(process.cwd(), args.path || ".");
	...
	for (const file of files) {
		...
		for (let i = 0; i < lines.length; i++) {
			...
			if (lines[i].toLowerCase().includes(lowerPattern)) {
				const relPath = nodePath.relative(cwd, file);
				let line = lines[i];
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/scripts/dev/shell.js
var MAX_OUTPUT = 5e4;
var TIMEOUT_MS = 3e4;
var tool = {
...
async function run(args) {
	...
	const cwd = args.cwd ? nodePath.resolve(process.cwd(), args.cwd) : process.cwd();
	try {
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/scripts/dev/index.js
/**
...
async function createDevScriptRegistry() {
	...
	try {
		const [dbSchema, dbQuery, dbExec, dbPatch, dbCheckScoping] = await Promise.all([
			...
			import("./check-scoping-pK-Yk7Ax.js")
		]);
		dbEntries = {
