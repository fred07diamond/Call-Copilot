...
import { n as readAppState, r as writeAppState, t as listAppState } from "./script-helpers-BSzah_dC.js";
import { h as runAgentLoop, r as actionsToEngineTools } from "./production-agent-CCgoSLGI.js";
import { t as createThread, u as buildAssistantMessage } from "./store-DCRHpmDW.js";
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/server/agent-teams.js
/**
...
async function spawnTask(opts) {
	...
	try {
		const { updateThreadData } = await import("./store-BgpGU_wv.js");
...
` + opts.systemPrompt;
	...
	startRun(runId, thread.id, async (send, signal) => {
		...
		if (opts.parentThreadId) try {
			const { getActiveRunForThread } = await import("./run-manager-Cb_oqaV6.js");
...
async function sendToTask(taskId, message) {
	...
	try {
		const { appStatePut } = await import("./store-BljV_oO22.js");
