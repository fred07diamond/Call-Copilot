...
import { i as getDbExec, u as isPostgres } from "./client-BpA2t7pN.js";
import { i as getRequestOrgId, l as runWithRequestContext } from "./request-context-BQ-cTIMw.js";
...
import { i as resolveAccess, t as ForbiddenError } from "./access-CcISFufT.js";
import { createExtension, deleteExtension, ensureExtensionsTables, getExtension, hideExtension, listExtensions, unhideExtension, updateExtension, updateExtensionContent } from "./store-CEKZrD2g.js";
import { a as normalizeExtensionProxyMethod, c as redactString, i as collectSecretValues, l as sanitizeOutboundHeaders, n as isBlockedExtensionUrlWithDns, o as readResponseTextWithLimit, s as redactSecrets, t as createSsrfSafeDispatcher } from "./url-safety-DThxocDu.js";
import { randomUUID } from "node:crypto";
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/extensions/html-shell.js
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/extensions/theme.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/extensions/routes.js
...
async function handleSqlQuery(event) {
	...
	try {
		const mod = await import("./query-l6I6tlwc.js");
		const args = [
			"--sql",
			sql,
			"--format",
...
async function handleSqlExec(event) {
	...
	try {
		const mod = await import("./exec-_zasVKHS.js");
		const args = [
			"--sql",
			sql,
			"--format",
