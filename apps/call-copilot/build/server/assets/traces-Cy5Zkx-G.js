//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/observability/types.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/observability/traces.js
function spanId() {
...
async function instrumentAgentLoop(opts) {
	...
	try {
		...
		let costCentsX100 = 0;
		try {
			const { calculateCost } = await import("./store-dZXzdqy-.js");
...
async function writeTraceData(spans, summary, runId, config) {
	const { insertTraceSpan, upsertTraceSummary } = await import("./store-Db0lGCWt.js");
	await Promise.all(spans.map((s) => insertTraceSpan(s).catch(() => {})));
	await upsertTraceSummary(summary).catch(() => {});
	try {
		const { evaluateRun } = await import("./evals-Ssn4_WnH.js");
