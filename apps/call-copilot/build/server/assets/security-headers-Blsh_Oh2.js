import { i as defineEventHandler, y as setResponseHeader } from "./node-DxyfkX8_.js";
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/server/security-headers.js
/**
...
var PERMISSIONS_POLICY = "camera=(), microphone=(self), geolocation=(), screen-wake-lock=()";
/**
...
function isHttpsRequest(event) {
	const xfp = event?.node?.req?.headers?.["x-forwarded-proto"] ?? event?.headers?.get?.("x-forwarded-proto");
...
function createSecurityHeadersMiddleware() {
	...
	return defineEventHandler((event) => {
		...
		if (isProduction) setResponseHeader(event, "X-Frame-Options", "DENY");
		...
		if (isHttpsRequest(event)) setResponseHeader(event, "Strict-Transport-Security", HSTS);
	});
}
//#endregion
