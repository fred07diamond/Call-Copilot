...
import { CLI_REGISTRY, commandExists, isAllowedCommand } from "./cli-registry-DvafFycT.js";
import path from "path";
import os from "os";
import { createServer } from "http";
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/terminal/pty-server.js
/**
...
async function createPtyWebSocketServer(options = {}) {
	...
	const { WebSocketServer, WebSocket } = await import("./wrapper-CVChg5P0.js").then((n) => n.n);
