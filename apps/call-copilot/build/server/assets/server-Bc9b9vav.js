...
import { a as getTask, c as touchQueuedA2ATaskDispatch, i as getA2ATaskDispatchState, l as updateTask, n as createTask, o as getTaskOwner, r as failStuckA2ATask, s as touchProcessingA2ATask, t as claimA2ATaskForProcessing } from "./task-store-CdMWPuNL.js";
import { t as agentChat } from "./agent-chat-B2U5wQS0.js";
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/a2a/auth-policy.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/a2a/agent-card.js
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/a2a/handlers.js
...
async function processA2ATaskFromQueue(taskId, config, event) {
	...
	const { runWithRequestContext } = await import("./request-context-BQ-cTIMw.js").then((n) => n.c);
...
async function resolveVerifiedA2AOrgId(verifiedEmail, verifiedOrgDomain) {
	if (verifiedOrgDomain) try {
		const { resolveOrgByDomain } = await import("./context-BMW-f2V6.js");
		const org = await resolveOrgByDomain(verifiedOrgDomain);
		if (org) return org.orgId;
	} catch {}
	if (verifiedEmail) try {
		const { resolveOrgIdForEmail } = await import("./context-BMW-f2V6.js");
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/a2a/server.js
/**
...
async function verifyA2AToken(token, event) {
	...
	if (orgDomainHint) try {
		const { getA2ASecretByDomain } = await import("./context-BMW-f2V6.js");
