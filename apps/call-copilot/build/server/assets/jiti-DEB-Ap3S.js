...
//#endregion
//#region ../../node_modules/.pnpm/jiti@2.7.0/node_modules/jiti/lib/jiti.mjs
var import_jiti = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	(() => {
		var e = {
		...
		(() => {
			...
			function nextLineBreak(e, t, i) {
				...
				for (var n = t; n < i; n++) {
					...
					if (isNewLine(a)) return n < i - 1 && 13 === a && 10 === e.charCodeAt(n + 1) ? n + 2 : n + 1;
				}
				return -1;
			}
			var B = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/, $ = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g, q = Object.prototype, W = q.hasOwnProperty, K = q.toString, H = Object.hasOwn || function(e, t) {
				return W.call(e, t);
			}, Y = Array.isArray || function(e) {
				return "[object Array]" === K.call(e);
			}, Q = Object.create(null);
			function wordsRegexp(e) {
				return Q[e] || (Q[e] = new RegExp("^(?:" + e.replace(/ /g, "|") + ")$"));
			}
			function codePointToString(e) {
				return e <= 65535 ? String.fromCharCode(e) : (e -= 65536, String.fromCharCode(55296 + (e >> 10), 56320 + (1023 & e)));
			}
			var Z = /(?:[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])/, acorn_Position = function(e, t) {
			...
			function getLineInfo(e, t) {
				for (var i = 1, n = 0;;) {
					var a = nextLineBreak(e, n, t);
					if (a < 0) return new acorn_Position(i, t - n);
					++i, n = a;
				}
			}
			var X = {
			...
			function getOptions(e) {
				var t = {};
				for (var i in X) t[i] = e && H(e, i) ? e[i] : X[i];
				if ("latest" === t.ecmaVersion ? t.ecmaVersion = 1e8 : null == t.ecmaVersion ? (!te && "object" == typeof console && console.warn && (te = !0, console.warn("Since Acorn 8.0.0, options.ecmaVersion is required.\nDefaulting to 2020, but this will stop working in the future.")), t.ecmaVersion = 11) : t.ecmaVersion >= 2015 && (t.ecmaVersion -= 2009), t.allowReserved ??= t.ecmaVersion < 5, e && null != e.allowHashBang || (t.allowHashBang = t.ecmaVersion >= 14), Y(t.onToken)) {
					var n = t.onToken;
					t.onToken = function(e) {
						return n.push(e);
					};
				}
				if (Y(t.onComment) && (t.onComment = function(e, t) {
					return function(i, n, a, c, l, y) {
						var E = {
							type: i ? "Block" : "Line",
							value: n,
							start: a,
						...
						e.locations && (E.loc = new acorn_SourceLocation(this, l, y)), e.ranges && (E.range = [a, c]), t.push(E);
					};
				}(t, t.onComment)), "commonjs" === t.sourceType && t.allowAwaitOutsideFunction) throw new Error("Cannot use allowAwaitOutsideFunction with sourceType: commonjs");
				return t;
			}
			var ie = 256, se = 259;
			...
			var acorn_Parser = function(e, t, i) {
				this.options = e = getOptions(e), this.sourceFile = e.sourceFile, this.keywords = wordsRegexp(y[e.ecmaVersion >= 6 ? 6 : "module" === e.sourceType ? "5module" : 5]);
				var n = "";
				!0 !== e.allowReserved && (n = c[e.ecmaVersion >= 6 ? 6 : 5 === e.ecmaVersion ? 5 : 3], "module" === e.sourceType && (n += " await")), this.reservedWords = wordsRegexp(n);
				var a = (n ? n + " " : "") + c.strict;
				this.reservedWordsStrict = wordsRegexp(a), this.reservedWordsStrictBind = wordsRegexp(a + " " + c.strictBind), this.input = String(t), this.containsEsc = !1, i ? (this.pos = i, this.lineStart = this.input.lastIndexOf("\n", i - 1) + 1, this.curLine = this.input.slice(0, this.lineStart).split(j).length) : (this.pos = this.lineStart = 0, this.curLine = 1), this.type = O.eof, this.value = null, this.start = this.end = this.pos, this.startLoc = this.endLoc = this.curPosition(), this.lastTokEndLoc = this.lastTokStartLoc = null, this.lastTokStart = this.lastTokEnd = this.pos, this.context = this.initialContext(), this.exprAllowed = !0, this.inModule = "module" === e.sourceType, this.strict = this.inModule || this.strictDirective(this.pos), this.potentialArrowAt = -1, this.potentialArrowInForAwait = !1, this.yieldPos = this.awaitPos = this.awaitIdentPos = 0, this.labels = [], this.undefinedExports = Object.create(null), 0 === this.pos && e.allowHashBang && "#!" === this.input.slice(0, 2) && this.skipLineComment(2), this.scopeStack = [], this.enterScope("commonjs" === this.options.sourceType ? 2 : 1), this.regexpState = null, this.privateNameStack = [];
			}, re = {
			...
			acorn_Parser.prototype.parse = function() {
				...
				return !(1024 & e) && !(!this.inModule && 1 & e);
			...
			ne.strictDirective = function(e) {
				...
				for (;;) {
					...
					if ("use strict" === (t[1] || t[2])) {
						...
						var i = $.exec(this.input), n = i.index + i[0].length, a = this.input.charAt(n);
						return ";" === a || "}" === a || j.test(i[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(a) || "!" === a && "=" === this.input.charAt(n + 1));
					}
			...
			oe.parseTopLevel = function(e) {
				...
				if (this.inModule) for (var n = 0, a = Object.keys(this.undefinedExports); n < a.length; n += 1) {
					var c = a[n];
					this.raiseRecoverable(this.undefinedExports[c].start, "Export '" + c + "' is not defined");
				}
				return this.adaptDirectivePrologue(e.body), this.next(), e.sourceType = "commonjs" === this.options.sourceType ? "script" : this.options.sourceType, this.finishNode(e, "Program");
			};
			var ce = { kind: "loop" }, he = { kind: "switch" };
			oe.isLet = function(e) {
				if (this.options.ecmaVersion < 6 || !this.isContextual("let")) return !1;
				$.lastIndex = this.pos;
				var t = $.exec(this.input), i = this.pos + t[0].length, n = this.fullCharCodeAt(i);
				if (91 === n || 92 === n) return !0;
				if (e) return !1;
				if (123 === n) return !0;
				if (isIdentifierStart(n)) {
					...
					do
						i += n <= 65535 ? 1 : 2;
					while (isIdentifierChar(n = this.fullCharCodeAt(i)));
					if (92 === n) return !0;
					var c = this.input.slice(a, i);
				...
				$.lastIndex = this.pos;
				var e, t = $.exec(this.input), i = this.pos + t[0].length;
				return !(j.test(this.input.slice(this.pos, i)) || "function" !== this.input.slice(i, i + 8) || i + 8 !== this.input.length && (isIdentifierChar(e = this.fullCharCodeAt(i + 8)) || 92 === e));
			}, oe.isUsingKeyword = function(e, t) {
				if (this.options.ecmaVersion < 17 || !this.isContextual(e ? "await" : "using")) return !1;
				$.lastIndex = this.pos;
				var i = $.exec(this.input), n = this.pos + i[0].length;
				if (j.test(this.input.slice(this.pos, n))) return !1;
				if (e) {
					var a, c = n + 5;
					if ("using" !== this.input.slice(n, c) || c === this.input.length || isIdentifierChar(a = this.fullCharCodeAt(c)) || 92 === a) return !1;
					$.lastIndex = c;
					var l = $.exec(this.input);
					if (n = c + l[0].length, l && j.test(this.input.slice(c, n))) return !1;
				}
				var y = this.fullCharCodeAt(n);
				if (!isIdentifierStart(y) && 92 !== y) return !1;
				var w = n;
				do
					n += y <= 65535 ? 1 : 2;
				while (isIdentifierChar(y = this.fullCharCodeAt(n)));
				if (92 === y) return !0;
				var C = this.input.slice(w, n);
				return !(E.test(C) || t && "of" === C);
			}, oe.isAwaitUsing = function(e) {
				return this.isUsingKeyword(!0, e);
			}, oe.isUsing = function(e) {
				return this.isUsingKeyword(!1, e);
			}, oe.parseStatement = function(e, t, i) {
				var n, a = this.type, c = this.startNode();
				switch (this.isLet(e) && (a = O._var, n = "let"), a) {
					case O._break:
					case O._continue: return this.parseBreakContinueStatement(c, a.keyword);
					case O._debugger: return this.parseDebuggerStatement(c);
					case O._do: return this.parseDoStatement(c);
					case O._for: return this.parseForStatement(c);
					case O._function: return e && (this.strict || "if" !== e && "label" !== e) && this.options.ecmaVersion >= 6 && this.unexpected(), this.parseFunctionStatement(c, !1, !e);
					case O._class: return e && this.unexpected(), this.parseClass(c, !0);
					case O._if: return this.parseIfStatement(c);
					case O._return: return this.parseReturnStatement(c);
					case O._switch: return this.parseSwitchStatement(c);
					case O._throw: return this.parseThrowStatement(c);
					case O._try: return this.parseTryStatement(c);
					case O._const:
					case O._var: return n = n || this.value, e && "var" !== n && this.unexpected(), this.parseVarStatement(c, n);
					case O._while: return this.parseWhileStatement(c);
					case O._with: return this.parseWithStatement(c);
					case O.braceL: return this.parseBlock(!0, c);
					case O.semi: return this.parseEmptyStatement(c);
					case O._export:
					case O._import:
						if (this.options.ecmaVersion > 10 && a === O._import) {
							$.lastIndex = this.pos;
							var l = $.exec(this.input), y = this.pos + l[0].length, E = this.input.charCodeAt(y);
							if (40 === E || 46 === E) return this.parseExpressionStatement(c, this.parseExpression());
						}
						return this.options.allowImportExportEverywhere || (t || this.raise(this.start, "'import' and 'export' may only appear at the top level"), this.inModule || this.raise(this.start, "'import' and 'export' may appear only with 'sourceType: module'")), a === O._import ? this.parseImport(c) : this.parseExport(c, i);
					default:
						if (this.isAsyncFunction()) return e && this.unexpected(), this.next(), this.parseFunctionStatement(c, !0, !e);
						var w = this.isAwaitUsing(!1) ? "await using" : this.isUsing(!1) ? "using" : null;
						if (w) return this.allowUsing || this.raise(this.start, "Using declaration cannot appear in the top level when source type is `script` or in the bare case statement"), "await using" === w && (this.canAwait || this.raise(this.start, "Await using cannot appear outside of async function"), this.next()), this.next(), this.parseVar(c, !1, w), this.semicolon(), this.finishNode(c, "VariableDeclaration");
						var C = this.value, S = this.parseExpression();
						return a === O.name && "Identifier" === S.type && this.eat(O.colon) ? this.parseLabeledStatement(c, C, S, e) : this.parseExpressionStatement(c, S);
				}
				...
				return this.next(), this.labels.push(ce), e.body = this.parseStatement("do"), this.labels.pop(), this.expect(O._while), e.test = this.parseParenExpression(), this.options.ecmaVersion >= 6 ? this.eat(O.semi) : this.semicolon(), this.finishNode(e, "DoWhileStatement");
			}, oe.parseForStatement = function(e) {
				this.next();
				var t = this.options.ecmaVersion >= 9 && this.canAwait && this.eatContextual("await") ? this.lastTokStart : -1;
				if (this.labels.push(ce), this.enterScope(0), this.expect(O.parenL), this.type === O.semi) return t > -1 && this.unexpected(t), this.parseFor(e, null);
				var i = this.isLet();
				if (this.type === O._var || this.type === O._const || i) {
					var n = this.startNode(), a = i ? "let" : this.value;
					return this.next(), this.parseVar(n, !0, a), this.finishNode(n, "VariableDeclaration"), this.parseForAfterInit(e, n, t);
				}
				var c = this.isContextual("let"), l = !1, y = this.isUsing(!0) ? "using" : this.isAwaitUsing(!0) ? "await using" : null;
				if (y) {
					var E = this.startNode();
					return this.next(), "await using" === y && (this.canAwait || this.raise(this.start, "Await using cannot appear outside of async function"), this.next()), this.parseVar(E, !0, y), this.finishNode(E, "VariableDeclaration"), this.parseForAfterInit(e, E, t);
				}
				var w = this.containsEsc, C = new acorn_DestructuringErrors(), S = this.start, I = t > -1 ? this.parseExprSubscripts(C, "await") : this.parseExpression(!0, C);
				return this.type === O._in || (l = this.options.ecmaVersion >= 6 && this.isContextual("of")) ? (t > -1 ? (this.type === O._in && this.unexpected(t), e.await = !0) : l && this.options.ecmaVersion >= 8 && (I.start !== S || w || "Identifier" !== I.type || "async" !== I.name ? this.options.ecmaVersion >= 9 && (e.await = !1) : this.unexpected()), c && l && this.raise(I.start, "The left-hand side of a for-of loop may not start with 'let'."), this.toAssignable(I, !1, C), this.checkLValPattern(I), this.parseForIn(e, I)) : (this.checkExpressionErrors(C, !0), t > -1 && this.unexpected(t), this.parseFor(e, I));
			}, oe.parseForAfterInit = function(e, t, i) {
				return (this.type === O._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) && 1 === t.declarations.length ? (this.options.ecmaVersion >= 9 && (this.type === O._in ? i > -1 && this.unexpected(i) : e.await = i > -1), this.parseForIn(e, t)) : (i > -1 && this.unexpected(i), this.parseFor(e, t));
			}, oe.parseFunctionStatement = function(e, t, i) {
				...
				var t;
				this.next(), e.discriminant = this.parseParenExpression(), e.cases = [], this.expect(O.braceL), this.labels.push(he), this.enterScope(1024);
				for (var i = !1; this.type !== O.braceR;) if (this.type === O._case || this.type === O._default) {
					var n = this.type === O._case;
					t && this.finishNode(t, "SwitchCase"), e.cases.push(t = this.startNode()), t.consequent = [], this.next(), n ? t.test = this.parseExpression() : (i && this.raiseRecoverable(this.lastTokStart, "Multiple default clauses"), i = !0, t.test = null), this.expect(O.colon);
			...
			oe.parseCatchClauseParam = function() {
				...
				return this.enterScope(t ? 32 : 0), this.checkLValPattern(e, t ? 4 : 2), this.expect(O.parenR), e;
			...
			}, oe.parseVarStatement = function(e, t, i) {
				...
				return this.next(), e.test = this.parseParenExpression(), this.labels.push(ce), e.body = this.parseStatement("while"), this.labels.pop(), this.finishNode(e, "WhileStatement");
			}, oe.parseWithStatement = function(e) {
				return this.strict && this.raise(this.start, "'with' in strict mode"), this.next(), e.object = this.parseParenExpression(), e.body = this.parseStatement("with"), this.finishNode(e, "WithStatement");
			}, oe.parseEmptyStatement = function(e) {
				return this.next(), this.finishNode(e, "EmptyStatement");
			}, oe.parseLabeledStatement = function(e, t, i, n) {
				for (var a = 0, c = this.labels; a < c.length; a += 1) c[a].name === t && this.raise(i.start, "Label '" + t + "' is already declared");
				for (var l = this.type.isLoop ? "loop" : this.type === O._switch ? "switch" : null, y = this.labels.length - 1; y >= 0; y--) {
					var E = this.labels[y];
					if (E.statementStart !== e.start) break;
					E.statementStart = this.start, E.kind = l;
				}
				return this.labels.push({
					name: t,
					kind: l,
					statementStart: this.start
				}), e.body = this.parseStatement(n ? -1 === n.indexOf("label") ? n + "label" : n : "label"), this.labels.pop(), e.label = i, this.finishNode(e, "LabeledStatement");
			}, oe.parseExpressionStatement = function(e, t) {
				return e.expression = t, this.semicolon(), this.finishNode(e, "ExpressionStatement");
			}, oe.parseBlock = function(e, t, i) {
				for (void 0 === e && (e = !0), void 0 === t && (t = this.startNode()), t.body = [], this.expect(O.braceL), e && this.enterScope(0); this.type !== O.braceR;) {
			...
			function isPrivateNameConflicted(e, t) {
				var i = t.key.name, n = e[i], a = "true";
				return "MethodDefinition" !== t.type || "get" !== t.kind && "set" !== t.kind || (a = (t.static ? "s" : "i") + t.kind), "iget" === n && "iset" === a || "iset" === n && "iget" === a || "sget" === n && "sset" === a || "sset" === n && "sget" === a ? (e[i] = "true", !1) : !!n || (e[i] = a, !1);
			}
			function checkKeyName(e, t) {
				var i = e.computed, n = e.key;
				return !i && ("Identifier" === n.type && n.name === t || "Literal" === n.type && n.value === t);
			}
			oe.parseFunction = function(e, t, i, n, a) {
				...
				var c = this.yieldPos, l = this.awaitPos, y = this.awaitIdentPos;
				return this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(functionFlags(e.async, e.generator)), t & pe || (e.id = this.type === O.name ? this.parseIdent() : null), this.parseFunctionParams(e), this.parseFunctionBody(e, i, !1, a), this.yieldPos = c, this.awaitPos = l, this.awaitIdentPos = y, this.finishNode(e, t & pe ? "FunctionDeclaration" : "FunctionExpression");
				...
				var n = this.enterClassBody(), a = this.startNode(), c = !1;
				for (a.body = [], this.expect(O.braceL); this.type !== O.braceR;) {
					var l = this.parseClassElement(null !== e.superClass);
					l && (a.body.push(l), "MethodDefinition" === l.type && "constructor" === l.kind ? (c && this.raiseRecoverable(l.start, "Duplicate constructor in the same class"), c = !0) : l.key && "PrivateIdentifier" === l.key.type && isPrivateNameConflicted(n, l) && this.raiseRecoverable(l.key.start, "Identifier '#" + l.key.name + "' has already been declared"));
				}
				...
				var t = this.options.ecmaVersion, i = this.startNode(), n = "", a = !1, c = !1, l = "method", y = !1;
				if (this.eatContextual("static")) {
					if (t >= 13 && this.eat(O.braceL)) return this.parseClassStaticBlock(i), i;
					this.isClassElementNameStart() || this.type === O.star ? y = !0 : n = "static";
				}
				if (i.static = y, !n && t >= 8 && this.eatContextual("async") && (!this.isClassElementNameStart() && this.type !== O.star || this.canInsertSemicolon() ? n = "async" : c = !0), !n && (t >= 9 || !c) && this.eat(O.star) && (a = !0), !n && !c && !a) {
					var E = this.value;
					(this.eatContextual("get") || this.eatContextual("set")) && (this.isClassElementNameStart() ? l = E : n = E);
				}
				if (n ? (i.computed = !1, i.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), i.key.name = n, this.finishNode(i.key, "Identifier")) : this.parseClassElementName(i), t < 13 || this.type === O.parenL || "method" !== l || a || c) {
					var w = !i.static && checkKeyName(i, "constructor"), C = w && e;
					w && "method" !== l && this.raise(i.key.start, "Constructor can't have get/set modifier"), i.kind = w ? "constructor" : l, this.parseClassMethod(i, a, c, C);
				...
				this.type === O.privateId ? ("constructor" === this.value && this.raise(this.start, "Classes can't have an element named '#constructor'"), e.computed = !1, e.key = this.parsePrivateIdent()) : this.parsePropertyName(e);
			}, oe.parseClassMethod = function(e, t, i, n) {
				var a = e.key;
				"constructor" === e.kind ? (t && this.raise(a.start, "Constructor can't be a generator"), i && this.raise(a.start, "Constructor can't be an async method")) : e.static && checkKeyName(e, "prototype") && this.raise(a.start, "Classes may not have a static property named prototype");
				var c = e.value = this.parseMethod(t, i, n);
				return "get" === e.kind && 0 !== c.params.length && this.raiseRecoverable(c.start, "getter should have no params"), "set" === e.kind && 1 !== c.params.length && this.raiseRecoverable(c.start, "setter should have exactly one param"), "set" === e.kind && "RestElement" === c.params[0].type && this.raiseRecoverable(c.params[0].start, "Setter cannot use rest params"), this.finishNode(e, "MethodDefinition");
			}, oe.parseClassField = function(e) {
				return checkKeyName(e, "constructor") ? this.raise(e.key.start, "Classes can't have a field named 'constructor'") : e.static && checkKeyName(e, "prototype") && this.raise(e.key.start, "Classes can't have a static field named 'prototype'"), this.eat(O.eq) ? (this.enterScope(576), e.value = this.parseMaybeAssign(), this.exitScope()) : e.value = null, this.semicolon(), this.finishNode(e, "PropertyDefinition");
				...
				this.type === O.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, 2, !1)) : (!0 === t && this.unexpected(), e.id = null);
				...
				if (this.options.checkPrivateFields) for (var n = this.privateNameStack.length, a = 0 === n ? null : this.privateNameStack[n - 1], c = 0; c < i.length; ++c) {
					var l = i[c];
					H(t, l.name) || (a ? a.used.push(l) : this.raiseRecoverable(l.start, "Private field '#" + l.name + "' must be declared in an enclosing class"));
				}
				...
				if (this.shouldParseExportStatement()) e.declaration = this.parseExportDeclaration(e), "VariableDeclaration" === e.declaration.type ? this.checkVariableExport(t, e.declaration.declarations) : this.checkExport(t, e.declaration.id, e.declaration.id.start), e.specifiers = [], e.source = null, this.options.ecmaVersion >= 16 && (e.attributes = []);
					...
					if (e.declaration = null, e.specifiers = this.parseExportSpecifiers(t), this.eatContextual("from")) this.type !== O.string && this.unexpected(), e.source = this.parseExprAtom(), this.options.ecmaVersion >= 16 && (e.attributes = this.parseWithClause());
						...
						for (var i = 0, n = e.specifiers; i < n.length; i += 1) {
							var a = n[i];
							this.checkUnreserved(a.local), this.checkLocalExport(a.local), "Literal" === a.local.type && this.raise(a.local.start, "A string literal cannot be used as an exported binding without `from`.");
						}
				...
				if (this.type === O._function || (e = this.isAsyncFunction())) {
					var t = this.startNode();
					return this.next(), e && this.next(), this.parseFunction(t, 4 | pe, !1, e);
				}
			...
			}, oe.checkExport = function(e, t, i) {
				e && ("string" != typeof t && (t = "Identifier" === t.type ? t.name : t.value), H(e, t) && this.raiseRecoverable(i, "Duplicate export '" + t + "'"), e[t] = !0);
			}, oe.checkPatternExport = function(e, t) {
				var i = t.type;
				if ("Identifier" === i) this.checkExport(e, t, t.start);
				else if ("ObjectPattern" === i) for (var n = 0, a = t.properties; n < a.length; n += 1) {
					var c = a[n];
					this.checkPatternExport(e, c);
				}
				else if ("ArrayPattern" === i) for (var l = 0, y = t.elements; l < y.length; l += 1) {
					var E = y[l];
					E && this.checkPatternExport(e, E);
				}
				...
				if (e) for (var i = 0, n = t; i < n.length; i += 1) {
					var a = n[i];
				...
				return this.next(), this.type === O.string ? (e.specifiers = le, e.source = this.parseExprAtom()) : (e.specifiers = this.parseImportSpecifiers(), this.expectContextual("from"), e.source = this.type === O.string ? this.parseExprAtom() : this.unexpected()), this.options.ecmaVersion >= 16 && (e.attributes = this.parseWithClause()), this.semicolon(), this.finishNode(e, "ImportDeclaration");
				...
				for (var t = {}, i = !0; !this.eat(O.braceR);) {
					if (i) i = !1;
					else if (this.expect(O.comma), this.afterTrailingComma(O.braceR)) break;
					var n = this.parseImportAttribute(), a = "Identifier" === n.key.type ? n.key.name : n.key.value;
					H(t, a) && this.raiseRecoverable(n.key.start, "Duplicate attribute key '" + a + "'"), t[a] = !0, e.push(n);
				}
				return e;
			}, oe.parseImportAttribute = function() {
				var e = this.startNode();
				return e.key = this.type === O.string ? this.parseExprAtom() : this.parseIdent("never" !== this.options.allowReserved), this.expect(O.colon), this.type !== O.string && this.unexpected(), e.value = this.parseExprAtom(), this.finishNode(e, "ImportAttribute");
			}, oe.parseModuleExportName = function() {
				if (this.options.ecmaVersion >= 13 && this.type === O.string) {
					var e = this.parseLiteral(this.value);
					return Z.test(e.value) && this.raise(e.start, "An export name cannot include a lone surrogate."), e;
				}
			...
			de.toAssignable = function(e, t, i) {
				if (this.options.ecmaVersion >= 6 && e) switch (e.type) {
					...
					case "ObjectExpression":
						...
						for (var n = 0, a = e.properties; n < a.length; n += 1) {
							var c = a[n];
							this.toAssignable(c, t), "RestElement" !== c.type || "ArrayPattern" !== c.argument.type && "ObjectPattern" !== c.argument.type || this.raise(c.argument.start, "Unexpected token");
						}
						break;
					case "Property":
				...
				if (i) {
					var c = e[i - 1];
					6 === this.options.ecmaVersion && t && c && "RestElement" === c.type && "Identifier" !== c.argument.type && this.unexpected(c.argument.start);
				}
				return e;
				...
				var e = this.startNode();
				return this.next(), 6 === this.options.ecmaVersion && this.type !== O.name && this.unexpected(), e.argument = this.parseBindingAtom(), this.finishNode(e, "RestElement");
			...
			}, de.parseBindingList = function(e, t, i, n) {
				for (var a = [], c = !0; !this.eat(e);) if (c ? c = !1 : this.expect(O.comma), t && this.type === O.comma) a.push(null);
				else {
					if (i && this.afterTrailingComma(e)) break;
					if (this.type === O.ellipsis) {
						var l = this.parseRestBinding();
						this.parseBindingListItem(l), a.push(l), this.type === O.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element"), this.expect(e);
						break;
					}
				...
				return e;
			}, de.parseMaybeDefault = function(e, t, i) {
			...
			}, de.checkLValSimple = function(e, t, i) {
				void 0 === t && (t = 0);
				var n = 0 !== t;
				switch (e.type) {
					case "Identifier":
						this.strict && this.reservedWordsStrictBind.test(e.name) && this.raiseRecoverable(e.start, (n ? "Binding " : "Assigning to ") + e.name + " in strict mode"), n && (2 === t && "let" === e.name && this.raiseRecoverable(e.start, "let is disallowed as a lexically bound name"), i && (H(i, e.name) && this.raiseRecoverable(e.start, "Argument name clash"), i[e.name] = !0), 5 !== t && this.declareName(e.name, t, e.start));
						break;
					case "ChainExpression":
						this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
						break;
					...
					default: this.raise(e.start, (n ? "Binding" : "Assigning to") + " rvalue");
				}
			}, de.checkLValPattern = function(e, t, i) {
				switch (void 0 === t && (t = 0), e.type) {
					case "ObjectPattern":
						...
						break;
					case "ArrayPattern":
						for (var l = 0, y = e.elements; l < y.length; l += 1) {
							var E = y[l];
							E && this.checkLValInnerPattern(E, t, i);
						}
						break;
					default: this.checkLValSimple(e, t, i);
				}
			}, de.checkLValInnerPattern = function(e, t, i) {
				switch (void 0 === t && (t = 0), e.type) {
					case "Property":
			...
			var acorn_TokContext = function(e, t, i, n, a) {
				this.token = e, this.isExpr = !!t, this.preserveSpace = !!i, this.override = n, this.generator = !!a;
			}, fe = {
			...
			me.initialContext = function() {
			...
			}, me.braceIsBlock = function(e) {
				var t = this.curContext();
				return t === fe.f_expr || t === fe.f_stat || (e !== O.colon || t !== fe.b_stat && t !== fe.b_expr ? e === O._return || e === O.name && this.exprAllowed ? j.test(this.input.slice(this.lastTokEnd, this.start)) : e === O._else || e === O.semi || e === O.eof || e === O.parenR || e === O.arrow || (e === O.braceL ? t === fe.b_stat : e !== O._var && e !== O._const && e !== O.name && !this.exprAllowed) : !t.isExpr);
				...
				return !1;
			}, me.updateContext = function(e) {
				var t, i = this.type;
				i.keyword && e === O.dot ? this.exprAllowed = !1 : (t = i.updateContext) ? t.call(this, e) : this.exprAllowed = i.beforeExpr;
			}, me.overrideContext = function(e) {
				this.curContext() !== e && (this.context[this.context.length - 1] = e);
			}, O.parenR.updateContext = O.braceR.updateContext = function() {
				if (1 !== this.context.length) {
					var e = this.context.pop();
					e === fe.b_stat && "function" === this.curContext().token && (e = this.context.pop()), this.exprAllowed = !e.isExpr;
				...
				!e.beforeExpr || e === O._else || e === O.semi && this.curContext() !== fe.p_stat || e === O._return && j.test(this.input.slice(this.lastTokEnd, this.start)) || (e === O.colon || e === O.braceL) && this.curContext() === fe.b_stat ? this.context.push(fe.f_stat) : this.context.push(fe.f_expr), this.exprAllowed = !1;
				...
				var t = !1;
				this.options.ecmaVersion >= 6 && e !== O.dot && ("of" === this.value && !this.exprAllowed || "yield" === this.value && this.inGeneratorContext()) && (t = !0), this.exprAllowed = t;
			};
			...
			ge.checkPropClash = function(e, t, i) {
				if (!(this.options.ecmaVersion >= 9 && "SpreadElement" === e.type || this.options.ecmaVersion >= 6 && (e.computed || e.method || e.shorthand))) {
					...
					var c = e.kind;
					if (this.options.ecmaVersion >= 6) "__proto__" === n && "init" === c && (t.proto && (i ? i.doubleProto < 0 && (i.doubleProto = a.start) : this.raiseRecoverable(a.start, "Redefinition of __proto__ property")), t.proto = !0);
					else {
						var l = t[n = "$" + n];
						if (l) ("init" === c ? this.strict && l.init || l.get || l.set : l.init || l[c]) && this.raiseRecoverable(a.start, "Redefinition of property");
						else l = t[n] = {
							init: !1,
							get: !1,
							set: !1
			...
			}, ge.parseExpression = function(e, t) {
				var i = this.start, n = this.startLoc, a = this.parseMaybeAssign(e, t);
				if (this.type === O.comma) {
					var c = this.startNodeAt(i, n);
					for (c.expressions = [a]; this.eat(O.comma);) c.expressions.push(this.parseMaybeAssign(e, t));
					return this.finishNode(c, "SequenceExpression");
				}
				return a;
			}, ge.parseMaybeAssign = function(e, t, i) {
				if (this.isContextual("yield")) {
					if (this.inGenerator) return this.parseYield(e);
					this.exprAllowed = !1;
				}
				var n = !1, a = -1, c = -1, l = -1;
				t ? (a = t.parenthesizedAssign, c = t.trailingComma, l = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new acorn_DestructuringErrors(), n = !0);
				var y = this.start, E = this.startLoc;
				this.type !== O.parenL && this.type !== O.name || (this.potentialArrowAt = this.start, this.potentialArrowInForAwait = "await" === e);
				var w = this.parseMaybeConditional(e, t);
				if (i && (w = i.call(this, w, y, E)), this.type.isAssign) {
					var C = this.startNodeAt(y, E);
					return C.operator = this.value, this.type === O.eq && (w = this.toAssignable(w, !1, t)), n || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= w.start && (t.shorthandAssign = -1), this.type === O.eq ? this.checkLValPattern(w) : this.checkLValSimple(w), C.left = w, this.next(), C.right = this.parseMaybeAssign(e), l > -1 && (t.doubleProto = l), this.finishNode(C, "AssignmentExpression");
				}
				return n && this.checkExpressionErrors(t, !0), a > -1 && (t.parenthesizedAssign = a), c > -1 && (t.trailingComma = c), w;
			}, ge.parseMaybeConditional = function(e, t) {
				var i = this.start, n = this.startLoc, a = this.parseExprOps(e, t);
				if (this.checkExpressionErrors(t)) return a;
				if (this.eat(O.question)) {
					var c = this.startNodeAt(i, n);
					return c.test = a, c.consequent = this.parseMaybeAssign(), this.expect(O.colon), c.alternate = this.parseMaybeAssign(e), this.finishNode(c, "ConditionalExpression");
				}
				return a;
			}, ge.parseExprOps = function(e, t) {
				var i = this.start, n = this.startLoc, a = this.parseMaybeUnary(t, !1, !1, e);
				return this.checkExpressionErrors(t) || a.start === i && "ArrowFunctionExpression" === a.type ? a : this.parseExprOp(a, i, n, -1, e);
			}, ge.parseExprOp = function(e, t, i, n, a) {
				var c = this.type.binop;
				if (null != c && (!a || this.type !== O._in) && c > n) {
					var l = this.type === O.logicalOR || this.type === O.logicalAND, y = this.type === O.coalesce;
					y && (c = O.logicalAND.binop);
					var E = this.value;
					this.next();
					var w = this.start, C = this.startLoc, S = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, a), w, C, c, a), I = this.buildBinary(t, i, e, S, E, l || y);
					return (l && this.type === O.coalesce || y && (this.type === O.logicalOR || this.type === O.logicalAND)) && this.raiseRecoverable(this.start, "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses"), this.parseExprOp(I, t, i, n, a);
				}
				return e;
			}, ge.buildBinary = function(e, t, i, n, a, c) {
				...
				return l.left = i, l.operator = a, l.right = n, this.finishNode(l, c ? "LogicalExpression" : "BinaryExpression");
			}, ge.parseMaybeUnary = function(e, t, i, n) {
				var a, c = this.start, l = this.startLoc;
				if (this.isContextual("await") && this.canAwait) a = this.parseAwait(n), t = !0;
				else if (this.type.prefix) {
					var y = this.startNode(), E = this.type === O.incDec;
					y.operator = this.value, y.prefix = !0, this.next(), y.argument = this.parseMaybeUnary(null, !0, E, n), this.checkExpressionErrors(e, !0), E ? this.checkLValSimple(y.argument) : this.strict && "delete" === y.operator && isLocalVariableAccess(y.argument) ? this.raiseRecoverable(y.start, "Deleting local variable in strict mode") : "delete" === y.operator && isPrivateFieldAccess(y.argument) ? this.raiseRecoverable(y.start, "Private fields can not be deleted") : t = !0, a = this.finishNode(y, E ? "UpdateExpression" : "UnaryExpression");
				} else if (t || this.type !== O.privateId) {
					if (a = this.parseExprSubscripts(e, n), this.checkExpressionErrors(e)) return a;
					for (; this.type.postfix && !this.canInsertSemicolon();) {
						var w = this.startNodeAt(c, l);
						w.operator = this.value, w.prefix = !1, w.argument = a, this.checkLValSimple(a), this.next(), a = this.finishNode(w, "UpdateExpression");
					}
				} else (n || 0 === this.privateNameStack.length) && this.options.checkPrivateFields && this.unexpected(), a = this.parsePrivateIdent(), this.type !== O._in && this.unexpected();
				return i || !this.eat(O.starstar) ? a : t ? void this.unexpected(this.lastTokStart) : this.buildBinary(c, l, a, this.parseMaybeUnary(null, !1, !1, n), "**", !1);
			}, ge.parseExprSubscripts = function(e, t) {
				var i = this.start, n = this.startLoc, a = this.parseExprAtom(e, t);
				if ("ArrowFunctionExpression" === a.type && ")" !== this.input.slice(this.lastTokStart, this.lastTokEnd)) return a;
				var c = this.parseSubscripts(a, i, n, !1, t);
				return e && "MemberExpression" === c.type && (e.parenthesizedAssign >= c.start && (e.parenthesizedAssign = -1), e.parenthesizedBind >= c.start && (e.parenthesizedBind = -1), e.trailingComma >= c.start && (e.trailingComma = -1)), c;
			}, ge.parseSubscripts = function(e, t, i, n, a) {
				for (var c = this.options.ecmaVersion >= 8 && "Identifier" === e.type && "async" === e.name && this.lastTokEnd === e.end && !this.canInsertSemicolon() && e.end - e.start === 5 && this.potentialArrowAt === e.start, l = !1;;) {
					var y = this.parseSubscript(e, t, i, n, c, l, a);
					if (y.optional && (l = !0), y === e || "ArrowFunctionExpression" === y.type) {
						if (l) {
							var E = this.startNodeAt(t, i);
							E.expression = y, y = this.finishNode(E, "ChainExpression");
						}
						return y;
					}
					e = y;
			...
			}, ge.parseSubscriptAsyncArrow = function(e, t, i, n) {
				return this.parseArrowExpression(this.startNodeAt(e, t), i, !0, n);
			}, ge.parseSubscript = function(e, t, i, n, a, c, l) {
				var y = this.options.ecmaVersion >= 11, E = y && this.eat(O.questionDot);
				n && E && this.raise(this.lastTokStart, "Optional chaining cannot appear in the callee of new expressions");
				var w = this.eat(O.bracketL);
				if (w || E && this.type !== O.parenL && this.type !== O.backQuote || this.eat(O.dot)) {
					var C = this.startNodeAt(t, i);
					C.object = e, w ? (C.property = this.parseExpression(), this.expect(O.bracketR)) : this.type === O.privateId && "Super" !== e.type ? C.property = this.parsePrivateIdent() : C.property = this.parseIdent("never" !== this.options.allowReserved), C.computed = !!w, y && (C.optional = E), e = this.finishNode(C, "MemberExpression");
				} else if (!n && this.eat(O.parenL)) {
					var S = new acorn_DestructuringErrors(), I = this.yieldPos, N = this.awaitPos, j = this.awaitIdentPos;
					this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0;
					var F = this.parseExprList(O.parenR, this.options.ecmaVersion >= 8, !1, S);
					if (a && !E && this.shouldParseAsyncArrow()) return this.checkPatternErrors(S, !1), this.checkYieldAwaitInDefaultParams(), this.awaitIdentPos > 0 && this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"), this.yieldPos = I, this.awaitPos = N, this.awaitIdentPos = j, this.parseSubscriptAsyncArrow(t, i, F, l);
					this.checkExpressionErrors(S, !0), this.yieldPos = I || this.yieldPos, this.awaitPos = N || this.awaitPos, this.awaitIdentPos = j || this.awaitIdentPos;
					var B = this.startNodeAt(t, i);
					B.callee = e, B.arguments = F, y && (B.optional = E), e = this.finishNode(B, "CallExpression");
				} else if (this.type === O.backQuote) {
					(E || c) && this.raise(this.start, "Optional chaining cannot appear in the tag of tagged template expressions");
					var $ = this.startNodeAt(t, i);
					$.tag = e, $.quasi = this.parseTemplate({ isTagged: !0 }), e = this.finishNode($, "TaggedTemplateExpression");
				}
				return e;
			}, ge.parseExprAtom = function(e, t, i) {
				...
				switch (this.type) {
					...
					case O._this: return n = this.startNode(), this.next(), this.finishNode(n, "ThisExpression");
					case O.name:
						var c = this.start, l = this.startLoc, y = this.containsEsc, E = this.parseIdent(!1);
						if (this.options.ecmaVersion >= 8 && !y && "async" === E.name && !this.canInsertSemicolon() && this.eat(O._function)) return this.overrideContext(fe.f_expr), this.parseFunction(this.startNodeAt(c, l), 0, !1, !0, t);
						if (a && !this.canInsertSemicolon()) {
							if (this.eat(O.arrow)) return this.parseArrowExpression(this.startNodeAt(c, l), [E], !1, t);
							if (this.options.ecmaVersion >= 8 && "async" === E.name && this.type === O.name && !y && (!this.potentialArrowInForAwait || "of" !== this.value || this.containsEsc)) return E = this.parseIdent(!1), !this.canInsertSemicolon() && this.eat(O.arrow) || this.unexpected(), this.parseArrowExpression(this.startNodeAt(c, l), [E], !0, t);
						}
						return E;
					case O.regexp:
						var w = this.value;
						return (n = this.parseLiteral(w.value)).regex = {
							pattern: w.pattern,
							flags: w.flags
						}, n;
					case O.num:
					...
					case O._null:
					case O._true:
					case O._false: return (n = this.startNode()).value = this.type === O._null ? null : this.type === O._true, n.raw = this.type.keyword, this.next(), this.finishNode(n, "Literal");
					case O.parenL:
						var C = this.start, S = this.parseParenAndDistinguishExpression(a, t);
						return e && (e.parenthesizedAssign < 0 && !this.isSimpleAssignTarget(S) && (e.parenthesizedAssign = C), e.parenthesizedBind < 0 && (e.parenthesizedBind = C)), S;
					case O.bracketL: return n = this.startNode(), this.next(), n.elements = this.parseExprList(O.bracketR, !0, !0, e), this.finishNode(n, "ArrayExpression");
					case O.braceL: return this.overrideContext(fe.b_expr), this.parseObj(!1, e);
					case O._function: return n = this.startNode(), this.next(), this.parseFunction(n, 0);
					...
					case O._import: return this.options.ecmaVersion >= 11 ? this.parseExprImport(i) : this.unexpected();
					default: return this.parseExprAtomDefault();
				}
			}, ge.parseExprAtomDefault = function() {
				this.unexpected();
			}, ge.parseExprImport = function(e) {
				var t = this.startNode();
				...
				this.unexpected();
			}, ge.parseDynamicImport = function(e) {
			...
			}, ge.shouldParseArrow = function(e) {
				return !this.canInsertSemicolon();
			}, ge.parseParenAndDistinguishExpression = function(e, t) {
				var i, n = this.start, a = this.startLoc, c = this.options.ecmaVersion >= 8;
				if (this.options.ecmaVersion >= 6) {
					this.next();
					var l, y = this.start, E = this.startLoc, w = [], C = !0, S = !1, I = new acorn_DestructuringErrors(), N = this.yieldPos, j = this.awaitPos;
					for (this.yieldPos = 0, this.awaitPos = 0; this.type !== O.parenR;) {
						if (C ? C = !1 : this.expect(O.comma), c && this.afterTrailingComma(O.parenR, !0)) {
							S = !0;
							break;
						}
						if (this.type === O.ellipsis) {
							l = this.start, w.push(this.parseParenItem(this.parseRestBinding())), this.type === O.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element");
							break;
						}
						w.push(this.parseMaybeAssign(!1, I, this.parseParenItem));
					}
					var F = this.lastTokEnd, B = this.lastTokEndLoc;
					if (this.expect(O.parenR), e && this.shouldParseArrow(w) && this.eat(O.arrow)) return this.checkPatternErrors(I, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = N, this.awaitPos = j, this.parseParenArrowList(n, a, w, t);
					w.length && !S || this.unexpected(this.lastTokStart), l && this.unexpected(l), this.checkExpressionErrors(I, !0), this.yieldPos = N || this.yieldPos, this.awaitPos = j || this.awaitPos, w.length > 1 ? ((i = this.startNodeAt(y, E)).expressions = w, this.finishNodeAt(i, "SequenceExpression", F, B)) : i = w[0];
				} else i = this.parseParenExpression();
				if (this.options.preserveParens) {
					var $ = this.startNodeAt(n, a);
					return $.expression = i, this.finishNode($, "ParenthesizedExpression");
				}
				return i;
			}, ge.parseParenItem = function(e) {
				return e;
			}, ge.parseParenArrowList = function(e, t, i, n) {
			...
			ge.parseNew = function() {
				...
				return e.callee = this.parseSubscripts(this.parseExprAtom(null, !1, !0), n, a, !0, !1), this.eat(O.parenL) ? e.arguments = this.parseExprList(O.parenR, this.options.ecmaVersion >= 8, !1) : e.arguments = xe, this.finishNode(e, "NewExpression");
			}, ge.parseTemplateElement = function(e) {
				var t = e.isTagged, i = this.startNode();
				return this.type === O.invalidTemplate ? (t || this.raiseRecoverable(this.start, "Bad escape sequence in untagged template literal"), i.value = {
					raw: this.value.replace(/\r\n?/g, "\n"),
					cooked: null
				}) : i.value = {
					raw: this.input.slice(this.start, this.end).replace(/\r\n?/g, "\n"),
					cooked: this.value
				}, this.next(), i.tail = this.type === O.backQuote, this.finishNode(i, "TemplateElement");
			}, ge.parseTemplate = function(e) {
				void 0 === e && (e = {});
				var t = e.isTagged;
				void 0 === t && (t = !1);
				var i = this.startNode();
			...
			}, ge.isAsyncProp = function(e) {
				return !e.computed && "Identifier" === e.key.type && "async" === e.key.name && (this.type === O.name || this.type === O.num || this.type === O.string || this.type === O.bracketL || this.type.keyword || this.options.ecmaVersion >= 9 && this.type === O.star) && !j.test(this.input.slice(this.lastTokEnd, this.start));
			}, ge.parseObj = function(e, t) {
				...
				for (i.properties = [], this.next(); !this.eat(O.braceR);) {
					...
					e || this.checkPropClash(c, a, t), i.properties.push(c);
				}
				return this.finishNode(i, e ? "ObjectPattern" : "ObjectExpression");
			}, ge.parseProperty = function(e, t) {
				var i, n, a, c, l = this.startNode();
				if (this.options.ecmaVersion >= 9 && this.eat(O.ellipsis)) return e ? (l.argument = this.parseIdent(!1), this.type === O.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element"), this.finishNode(l, "RestElement")) : (l.argument = this.parseMaybeAssign(!1, t), this.type === O.comma && t && t.trailingComma < 0 && (t.trailingComma = this.start), this.finishNode(l, "SpreadElement"));
				this.options.ecmaVersion >= 6 && (l.method = !1, l.shorthand = !1, (e || t) && (a = this.start, c = this.startLoc), e || (i = this.eat(O.star)));
				var y = this.containsEsc;
				return this.parsePropertyName(l), !e && !y && this.options.ecmaVersion >= 8 && !i && this.isAsyncProp(l) ? (n = !0, i = this.options.ecmaVersion >= 9 && this.eat(O.star), this.parsePropertyName(l)) : n = !1, this.parsePropertyValue(l, e, i, n, a, c, t, y), this.finishNode(l, "Property");
			}, ge.parseGetterSetter = function(e) {
				var t = e.key.name;
				this.parsePropertyName(e), e.value = this.parseMethod(!1), e.kind = t;
				var i = "get" === e.kind ? 0 : 1;
				if (e.value.params.length !== i) {
					var n = e.value.start;
					"get" === e.kind ? this.raiseRecoverable(n, "getter should have no params") : this.raiseRecoverable(n, "setter should have exactly one param");
			...
			}, ge.parsePropertyValue = function(e, t, i, n, a, c, l, y) {
			...
			}, ge.parsePropertyName = function(e) {
				if (this.options.ecmaVersion >= 6) {
					if (this.eat(O.bracketL)) return e.computed = !0, e.key = this.parseMaybeAssign(), this.expect(O.bracketR), e.key;
					e.computed = !1;
				}
				return e.key = this.type === O.num || this.type === O.string ? this.parseExprAtom() : this.parseIdent("never" !== this.options.allowReserved);
			}, ge.initFunction = function(e) {
				e.id = null, this.options.ecmaVersion >= 6 && (e.generator = e.expression = !1), this.options.ecmaVersion >= 8 && (e.async = !1);
			}, ge.parseMethod = function(e, t, i) {
				var n = this.startNode(), a = this.yieldPos, c = this.awaitPos, l = this.awaitIdentPos;
				return this.initFunction(n), this.options.ecmaVersion >= 6 && (n.generator = e), this.options.ecmaVersion >= 8 && (n.async = !!t), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(64 | functionFlags(t, n.generator) | (i ? 128 : 0)), this.expect(O.parenL), n.params = this.parseBindingList(O.parenR, !1, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams(), this.parseFunctionBody(n, !1, !0, !1), this.yieldPos = a, this.awaitPos = c, this.awaitIdentPos = l, this.finishNode(n, "FunctionExpression");
			}, ge.parseArrowExpression = function(e, t, i, n) {
				var a = this.yieldPos, c = this.awaitPos, l = this.awaitIdentPos;
				return this.enterScope(16 | functionFlags(i, !1)), this.initFunction(e), this.options.ecmaVersion >= 8 && (e.async = !!i), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, e.params = this.toAssignableList(t, !0), this.parseFunctionBody(e, !0, !1, n), this.yieldPos = a, this.awaitPos = c, this.awaitIdentPos = l, this.finishNode(e, "ArrowFunctionExpression");
			}, ge.parseFunctionBody = function(e, t, i, n) {
				var a = t && this.type !== O.braceL, c = this.strict, l = !1;
				if (a) e.body = this.parseMaybeAssign(n), e.expression = !0, this.checkParams(e, !1);
				else {
					var y = this.options.ecmaVersion >= 7 && !this.isSimpleParamList(e.params);
					c && !y || (l = this.strictDirective(this.end)) && y && this.raiseRecoverable(e.start, "Illegal 'use strict' directive in function with non-simple parameter list");
					var E = this.labels;
					this.labels = [], l && (this.strict = !0), this.checkParams(e, !c && !l && !t && !i && this.isSimpleParamList(e.params)), this.strict && e.id && this.checkLValSimple(e.id, 5), e.body = this.parseBlock(!1, void 0, l && !c), e.expression = !1, this.adaptDirectivePrologue(e.body.body), this.labels = E;
				}
				this.exitScope();
			}, ge.isSimpleParamList = function(e) {
				for (var t = 0, i = e; t < i.length; t += 1) if ("Identifier" !== i[t].type) return !1;
				return !0;
			}, ge.checkParams = function(e, t) {
				for (var i = Object.create(null), n = 0, a = e.params; n < a.length; n += 1) {
					var c = a[n];
					this.checkLValInnerPattern(c, 1, t ? null : i);
				}
			}, ge.parseExprList = function(e, t, i, n) {
				for (var a = [], c = !0; !this.eat(e);) {
					if (c) c = !1;
					else if (this.expect(O.comma), t && this.afterTrailingComma(e)) break;
					var l = void 0;
					i && this.type === O.comma ? l = null : this.type === O.ellipsis ? (l = this.parseSpread(n), n && this.type === O.comma && n.trailingComma < 0 && (n.trailingComma = this.start)) : l = this.parseMaybeAssign(!1, n), a.push(l);
				}
				return a;
			}, ge.checkUnreserved = function(e) {
				...
				var e = this.startNode();
				return this.type === O.name ? e.name = this.value : this.type.keyword ? (e.name = this.type.keyword, "class" !== e.name && "function" !== e.name || this.lastTokEnd === this.lastTokStart + 1 && 46 === this.input.charCodeAt(this.lastTokStart) || this.context.pop(), this.type = O.name) : this.unexpected(), e;
			...
			var ye = acorn_Parser.prototype, acorn_Scope = function(e) {
			...
			ye.enterScope = function(e) {
				...
				if (2 === t) {
					...
					n = this.treatFunctionsAsVar ? c.lexical.indexOf(e) > -1 : c.lexical.indexOf(e) > -1 || c.var.indexOf(e) > -1, c.functions.push(e);
				} else for (var l = this.scopeStack.length - 1; l >= 0; --l) {
					var y = this.scopeStack[l];
					if (y.lexical.indexOf(e) > -1 && !(32 & y.flags && y.lexical[0] === e) || !this.treatFunctionsAsVarInScope(y) && y.functions.indexOf(e) > -1) {
						n = !0;
						break;
					}
					if (y.var.push(e), this.inModule && 1 & y.flags && delete this.undefinedExports[e], y.flags & se) break;
				}
			...
			}, _e.startNodeAt = function(e, t) {
				return new acorn_Node(this, e, t);
			}, _e.finishNode = function(e, t) {
				return finishNodeAt.call(this, e, t, this.lastTokEnd, this.lastTokEndLoc);
			}, _e.finishNodeAt = function(e, t, i, n) {
				return finishNodeAt.call(this, e, t, i, n);
			...
			function buildUnicodeData(e) {
				var t = De[e] = {
					binary: wordsRegexp(we[e] + " " + Se),
					binaryOfStrings: wordsRegexp(Ce[e]),
					nonBinary: {
			...
			var Me = acorn_Parser.prototype, acorn_BranchID = function(e, t) {
			...
			acorn_RegExpValidationState.prototype.reset = function(e, t, i) {
				var n = -1 !== i.indexOf("v"), a = -1 !== i.indexOf("u");
				this.start = 0 | e, this.source = t + "", this.flags = i, n && this.parser.options.ecmaVersion >= 15 ? (this.switchU = !0, this.switchV = !0, this.switchN = !0) : (this.switchU = a && this.parser.options.ecmaVersion >= 6, this.switchV = !1, this.switchN = a && this.parser.options.ecmaVersion >= 9);
				...
				if (!t && !this.switchU || a <= 55295 || a >= 57344 || e + 1 >= n) return a;
				var c = i.charCodeAt(e + 1);
				return c >= 56320 && c <= 57343 ? (a << 10) + c - 56613888 : a;
			}, acorn_RegExpValidationState.prototype.nextIndex = function(e, t) {
				void 0 === t && (t = !1);
				var i = this.source, n = i.length;
				if (e >= n) return n;
				var a, c = i.charCodeAt(e);
				return !t && !this.switchU || c <= 55295 || c >= 57344 || e + 1 >= n || (a = i.charCodeAt(e + 1)) < 56320 || a > 57343 ? e + 1 : e + 2;
				...
				void 0 === t && (t = !1);
				for (var i = this.pos, n = 0, a = e; n < a.length; n += 1) {
					var c = a[n], l = this.at(i, t);
					if (-1 === l || l !== c) return !1;
					i = this.nextIndex(i, t);
				}
				return this.pos = i, !0;
			}, Me.validateRegExpFlags = function(e) {
				for (var t = e.validFlags, i = e.flags, n = !1, a = !1, c = 0; c < i.length; c++) {
					var l = i.charAt(c);
					-1 === t.indexOf(l) && this.raise(e.start, "Invalid regular expression flag"), i.indexOf(l, c + 1) > -1 && this.raise(e.start, "Duplicate regular expression flag"), "u" === l && (n = !0), "v" === l && (a = !0);
				}
				this.options.ecmaVersion >= 15 && n && a && this.raise(e.start, "Invalid regular expression flag");
			}, Me.validateRegExpPattern = function(e) {
				this.regexp_pattern(e), !e.switchN && this.options.ecmaVersion >= 9 && function(e) {
					for (var t in e) return !0;
					return !1;
				}(e.groupNames) && (e.switchN = !0, this.regexp_pattern(e));
			}, Me.regexp_pattern = function(e) {
			...
			}, Me.regexp_disjunction = function(e) {
			...
			}, Me.regexp_alternative = function(e) {
				for (; e.pos < e.source.length && this.regexp_eatTerm(e););
			}, Me.regexp_eatTerm = function(e) {
			...
			}, Me.regexp_eatAssertion = function(e) {
				var t = e.pos;
				...
				return e.pos = t, !1;
			}, Me.regexp_eatQuantifier = function(e, t) {
				return void 0 === t && (t = !1), !!this.regexp_eatQuantifierPrefix(e, t) && (e.eat(63), !0);
			}, Me.regexp_eatQuantifierPrefix = function(e, t) {
				return e.eat(42) || e.eat(43) || e.eat(63) || this.regexp_eatBracedQuantifier(e, t);
			}, Me.regexp_eatBracedQuantifier = function(e, t) {
				var i = e.pos;
				if (e.eat(123)) {
					var n = 0, a = -1;
				...
				return !1;
			}, Me.regexp_eatAtom = function(e) {
				return this.regexp_eatPatternCharacters(e) || e.eat(46) || this.regexp_eatReverseSolidusAtomEscape(e) || this.regexp_eatCharacterClass(e) || this.regexp_eatUncapturingGroup(e) || this.regexp_eatCapturingGroup(e);
			}, Me.regexp_eatReverseSolidusAtomEscape = function(e) {
				var t = e.pos;
				if (e.eat(92)) {
				...
				return !1;
			}, Me.regexp_eatUncapturingGroup = function(e) {
				var t = e.pos;
				if (e.eat(40)) {
					if (e.eat(63)) {
						if (this.options.ecmaVersion >= 16) {
							var i = this.regexp_eatModifiers(e), n = e.eat(45);
							if (i || n) {
								for (var a = 0; a < i.length; a++) {
									var c = i.charAt(a);
									i.indexOf(c, a + 1) > -1 && e.raise("Duplicate regular expression modifiers");
								}
								if (n) {
									var l = this.regexp_eatModifiers(e);
									i || l || 58 !== e.current() || e.raise("Invalid regular expression modifiers");
									for (var y = 0; y < l.length; y++) {
										var E = l.charAt(y);
										(l.indexOf(E, y + 1) > -1 || i.indexOf(E) > -1) && e.raise("Duplicate regular expression modifiers");
									}
								}
							}
						}
				...
				return !1;
			}, Me.regexp_eatCapturingGroup = function(e) {
				if (e.eat(40)) {
			...
			}, Me.regexp_eatGroupName = function(e) {
				if (e.lastStringValue = "", e.eat(60)) {
					if (this.regexp_eatRegExpIdentifierName(e) && e.eat(62)) return !0;
					e.raise("Invalid capture group name");
				}
				return !1;
			}, Me.regexp_eatRegExpIdentifierName = function(e) {
				...
				return !1;
			}, Me.regexp_eatRegExpIdentifierStart = function(e) {
				var t = e.pos, i = this.options.ecmaVersion >= 11, n = e.current(i);
				return e.advance(i), 92 === n && this.regexp_eatRegExpUnicodeEscapeSequence(e, i) && (n = e.lastIntValue), function(e) {
					return isIdentifierStart(e, !0) || 36 === e || 95 === e;
				}(n) ? (e.lastIntValue = n, !0) : (e.pos = t, !1);
			}, Me.regexp_eatRegExpIdentifierPart = function(e) {
				var t = e.pos, i = this.options.ecmaVersion >= 11, n = e.current(i);
				return e.advance(i), 92 === n && this.regexp_eatRegExpUnicodeEscapeSequence(e, i) && (n = e.lastIntValue), function(e) {
					return isIdentifierChar(e, !0) || 36 === e || 95 === e || 8204 === e || 8205 === e;
				}(n) ? (e.lastIntValue = n, !0) : (e.pos = t, !1);
			}, Me.regexp_eatAtomEscape = function(e) {
			...
			}, Me.regexp_eatBackReference = function(e) {
				var t = e.pos;
			...
			}, Me.regexp_eatControlLetter = function(e) {
				var t = e.current();
				return !!isControlLetter(t) && (e.lastIntValue = t % 32, e.advance(), !0);
			}, Me.regexp_eatRegExpUnicodeEscapeSequence = function(e, t) {
				void 0 === t && (t = !1);
				var i, n = e.pos, a = t || e.switchU;
				if (e.eat(117)) {
					if (this.regexp_eatFixedHexDigits(e, 4)) {
						var c = e.lastIntValue;
						if (a && c >= 55296 && c <= 56319) {
							var l = e.pos;
							if (e.eat(92) && e.eat(117) && this.regexp_eatFixedHexDigits(e, 4)) {
								var y = e.lastIntValue;
								if (y >= 56320 && y <= 57343) return e.lastIntValue = 1024 * (c - 55296) + (y - 56320) + 65536, !0;
							}
							e.pos = l, e.lastIntValue = c;
						}
						return !0;
					}
					if (a && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && (i = e.lastIntValue) >= 0 && i <= 1114111) return !0;
					a && e.raise("Invalid unicode escape"), e.pos = n;
				}
				return !1;
			}, Me.regexp_eatIdentityEscape = function(e) {
			...
			}, Me.regexp_eatDecimalEscape = function(e) {
				e.lastIntValue = 0;
				var t = e.current();
				if (t >= 49 && t <= 57) {
					do
			...
			Me.regexp_eatCharacterClassEscape = function(e) {
				var t = e.current();
				if (function(e) {
				...
				return 0;
			}, Me.regexp_eatUnicodePropertyValueExpression = function(e) {
				var t = e.pos;
				if (this.regexp_eatUnicodePropertyName(e) && e.eat(61)) {
					var i = e.lastStringValue;
					if (this.regexp_eatUnicodePropertyValue(e)) {
						var n = e.lastStringValue;
						return this.regexp_validateUnicodePropertyNameAndValue(e, i, n), 1;
					}
				}
				...
				return 0;
			}, Me.regexp_validateUnicodePropertyNameAndValue = function(e, t, i) {
				H(e.unicodeProperties.nonBinary, t) || e.raise("Invalid property name"), e.unicodeProperties.nonBinary[t].test(i) || e.raise("Invalid property value");
			}, Me.regexp_validateUnicodePropertyNameOrValue = function(e, t) {
			...
			}, Me.regexp_eatClassAtom = function(e) {
				var t = e.pos;
				if (e.eat(92)) {
			...
			}, Me.regexp_eatClassEscape = function(e) {
				var t = e.pos;
			...
			}, Me.regexp_classSetExpression = function(e) {
				var t, i = 1;
			...
			}, Me.regexp_eatClassSetRange = function(e) {
				var t = e.pos;
				if (this.regexp_eatClassSetCharacter(e)) {
					var i = e.lastIntValue;
					if (e.eat(45) && this.regexp_eatClassSetCharacter(e)) {
						var n = e.lastIntValue;
						return -1 !== i && -1 !== n && i > n && e.raise("Range out of order in character class"), !0;
					}
					e.pos = t;
				}
				return !1;
			}, Me.regexp_eatClassSetOperand = function(e) {
				return this.regexp_eatClassSetCharacter(e) ? 1 : this.regexp_eatClassStringDisjunction(e) || this.regexp_eatNestedClass(e);
			}, Me.regexp_eatNestedClass = function(e) {
				var t = e.pos;
				if (e.eat(91)) {
					var i = e.eat(94), n = this.regexp_classContents(e);
				...
				return null;
			}, Me.regexp_eatClassStringDisjunction = function(e) {
				var t = e.pos;
				...
				return null;
			}, Me.regexp_classStringDisjunctionContents = function(e) {
				for (var t = this.regexp_classString(e); e.eat(124);) 2 === this.regexp_classString(e) && (t = 2);
				return t;
			}, Me.regexp_classString = function(e) {
				for (var t = 0; this.regexp_eatClassSetCharacter(e);) t++;
				return 1 === t ? 1 : 2;
			}, Me.regexp_eatClassSetCharacter = function(e) {
				var t = e.pos;
				...
				return !1;
			}, Me.regexp_eatOctalDigit = function(e) {
				var t = e.current();
				return isOctalDigit(t) ? (e.lastIntValue = t - 48, e.advance(), !0) : (e.lastIntValue = 0, !1);
			}, Me.regexp_eatFixedHexDigits = function(e, t) {
				var i = e.pos;
				e.lastIntValue = 0;
				for (var n = 0; n < t; ++n) {
					var a = e.current();
					if (!isHexDigit(a)) return e.pos = i, !1;
			...
			je.next = function(e) {
				...
				return e && e.preserveSpace || this.skipSpace(), this.start = this.pos, this.options.locations && (this.startLoc = this.curPosition()), this.pos >= this.input.length ? this.finishToken(O.eof) : e.override ? e.override(this) : void this.readToken(this.fullCharCodeAtPos());
			}, je.readToken = function(e) {
				return isIdentifierStart(e, this.options.ecmaVersion >= 6) || 92 === e ? this.readWord() : this.getTokenFromCode(e);
			}, je.fullCharCodeAt = function(e) {
				...
				if (-1 === i && this.raise(this.pos - 2, "Unterminated comment"), this.pos = i + 2, this.options.locations) for (var n = void 0, a = t; (n = nextLineBreak(this.input, a, this.pos)) > -1;) ++this.curLine, a = this.lineStart = n;
				this.options.onComment && this.options.onComment(!0, this.input.slice(t + 2, i), t, this.pos, e, this.curPosition());
			}, je.skipLineComment = function(e) {
				for (var t = this.pos, i = this.options.onComment && this.curPosition(), n = this.input.charCodeAt(this.pos += e); this.pos < this.input.length && !isNewLine(n);) n = this.input.charCodeAt(++this.pos);
				...
				e: for (; this.pos < this.input.length;) {
					...
					switch (e) {
						...
						case 47:
							...
							break;
						default:
							if (!(e > 8 && e < 14 || e >= 5760 && B.test(String.fromCharCode(e)))) break e;
							++this.pos;
					}
				}
			}, je.finishToken = function(e, t) {
				...
				return this.options.ecmaVersion >= 6 && 46 === e && 46 === t ? (this.pos += 3, this.finishToken(O.ellipsis)) : (++this.pos, this.finishToken(O.dot));
			}, je.readToken_slash = function() {
				var e = this.input.charCodeAt(this.pos + 1);
				return this.exprAllowed ? (++this.pos, this.readRegexp()) : 61 === e ? this.finishOp(O.assign, 2) : this.finishOp(O.slash, 1);
			}, je.readToken_mult_modulo_exp = function(e) {
				var t = this.input.charCodeAt(this.pos + 1), i = 1, n = 42 === e ? O.star : O.modulo;
				return this.options.ecmaVersion >= 7 && 42 === e && 42 === t && (++i, n = O.starstar, t = this.input.charCodeAt(this.pos + 2)), 61 === t ? this.finishOp(O.assign, i + 1) : this.finishOp(n, i);
			}, je.readToken_pipe_amp = function(e) {
				var t = this.input.charCodeAt(this.pos + 1);
				if (t === e) {
					if (this.options.ecmaVersion >= 12) {
						if (61 === this.input.charCodeAt(this.pos + 2)) return this.finishOp(O.assign, 3);
					}
					return this.finishOp(124 === e ? O.logicalOR : O.logicalAND, 2);
				}
				return 61 === t ? this.finishOp(O.assign, 2) : this.finishOp(124 === e ? O.bitwiseOR : O.bitwiseAND, 1);
			...
			}, je.readToken_plus_min = function(e) {
				var t = this.input.charCodeAt(this.pos + 1);
				return t === e ? 45 !== t || this.inModule || 62 !== this.input.charCodeAt(this.pos + 2) || 0 !== this.lastTokEnd && !j.test(this.input.slice(this.lastTokEnd, this.pos)) ? this.finishOp(O.incDec, 2) : (this.skipLineComment(3), this.skipSpace(), this.nextToken()) : 61 === t ? this.finishOp(O.assign, 2) : this.finishOp(O.plusMin, 1);
			}, je.readToken_lt_gt = function(e) {
				var t = this.input.charCodeAt(this.pos + 1), i = 1;
				return t === e ? (i = 62 === e && 62 === this.input.charCodeAt(this.pos + 2) ? 3 : 2, 61 === this.input.charCodeAt(this.pos + i) ? this.finishOp(O.assign, i + 1) : this.finishOp(O.bitShift, i)) : 33 !== t || 60 !== e || this.inModule || 45 !== this.input.charCodeAt(this.pos + 2) || 45 !== this.input.charCodeAt(this.pos + 3) ? (61 === t && (i = 2), this.finishOp(O.relational, i)) : (this.skipLineComment(4), this.skipSpace(), this.nextToken());
			}, je.readToken_eq_excl = function(e) {
				var t = this.input.charCodeAt(this.pos + 1);
				return 61 === t ? this.finishOp(O.equality, 61 === this.input.charCodeAt(this.pos + 2) ? 3 : 2) : 61 === e && 62 === t && this.options.ecmaVersion >= 6 ? (this.pos += 2, this.finishToken(O.arrow)) : this.finishOp(61 === e ? O.eq : O.prefix, 1);
				...
				var e = 35;
				if (this.options.ecmaVersion >= 13 && (++this.pos, isIdentifierStart(e = this.fullCharCodeAtPos(), !0) || 92 === e)) return this.finishToken(O.privateId, this.readWord1());
				this.raise(this.pos, "Unexpected character '" + codePointToString(e) + "'");
			}, je.getTokenFromCode = function(e) {
				switch (e) {
				...
				for (var e, t, i = this.pos;;) {
					...
					if (j.test(n) && this.raise(i, "Unterminated regular expression"), e) e = !1;
					else {
						if ("[" === n) t = !0;
						else if ("]" === n && t) t = !1;
						else if ("/" === n && !t) break;
				...
				++this.pos;
				var c = this.pos, l = this.readWord1();
				this.containsEsc && this.unexpected(c);
				var y = this.regexpState || (this.regexpState = new acorn_RegExpValidationState(this));
				y.reset(i, a, l), this.validateRegExpFlags(y), this.validateRegExpPattern(y);
				var E = null;
				try {
					E = new RegExp(a, l);
				} catch (e) {}
				...
				for (var n = this.options.ecmaVersion >= 12 && void 0 === t, a = i && 48 === this.input.charCodeAt(this.pos), c = this.pos, l = 0, y = 0, E = 0, w = null == t ? Infinity : t; E < w; ++E, ++this.pos) {
					var C = this.input.charCodeAt(this.pos), S = void 0;
				...
				return n && 95 === y && this.raiseRecoverable(this.pos - 1, "Numeric separator is not allowed at the last of digits"), this.pos === c || null != t && this.pos - c !== t ? null : l;
			}, je.readRadixNumber = function(e) {
				var t = this.pos;
				this.pos += 2;
				var i = this.readInt(e);
				return i ?? this.raise(this.start + 2, "Expected number in radix " + e), this.options.ecmaVersion >= 11 && 110 === this.input.charCodeAt(this.pos) ? (i = stringToBigInt(this.input.slice(t, this.pos)), ++this.pos) : isIdentifierStart(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(O.num, i);
			}, je.readNumber = function(e) {
				var t = this.pos;
				e || null !== this.readInt(10, void 0, !0) || this.raise(t, "Invalid number");
				var i = this.pos - t >= 2 && 48 === this.input.charCodeAt(t);
				i && this.strict && this.raise(t, "Invalid number");
				var n = this.input.charCodeAt(this.pos);
				if (!i && !e && this.options.ecmaVersion >= 11 && 110 === n) {
				...
				var c, l = (c = this.input.slice(t, this.pos), i ? parseInt(c, 8) : parseFloat(c.replace(/_/g, "")));
			...
			je.tryReadTemplateToken = function() {
			...
			}, je.invalidStringToken = function(e, t) {
				...
				for (var e = "", t = this.pos;;) {
					...
					if (96 === i || 36 === i && 123 === this.input.charCodeAt(this.pos + 1)) return this.pos !== this.start || this.type !== O.template && this.type !== O.invalidTemplate ? (e += this.input.slice(t, this.pos), this.finishToken(O.template, e)) : 36 === i ? (this.pos += 2, this.finishToken(O.dollarBraceL)) : (++this.pos, this.finishToken(O.backQuote));
				...
				switch (++this.pos, t) {
					...
					default:
						if (t >= 48 && t <= 55) {
							...
							return a > 255 && (n = n.slice(0, -1), a = parseInt(n, 8)), this.pos += n.length - 1, t = this.input.charCodeAt(this.pos), "0" === n && 56 !== t && 57 !== t || !this.strict && !e || this.invalidStringToken(this.pos - 1 - n.length, e ? "Octal literal in template string" : "Octal literal in strict mode"), String.fromCharCode(a);
						}
						return isNewLine(t) ? (this.options.locations && (this.lineStart = this.pos, ++this.curLine), "") : String.fromCharCode(t);
				}
			}, je.readHexChar = function(e) {
				...
				for (var e = "", t = !0, i = this.pos, n = this.options.ecmaVersion >= 6; this.pos < this.input.length;) {
					...
					if (isIdentifierChar(a, n)) this.pos += a <= 65535 ? 1 : 2;
					else {
						if (92 !== a) break;
						...
						(t ? isIdentifierStart : isIdentifierChar)(l, n) || this.invalidStringToken(c, "Invalid Unicode escape"), e += codePointToString(l), i = this.pos;
					}
					t = !1;
				}
				...
				return this.keywords.test(e) && (t = N[e]), this.finishToken(t, e);
			};
			acorn_Parser.acorn = {
				Parser: acorn_Parser,
				version: "8.16.0",
			...
			function withTrailingSlash(e = "", t) {
				...
				let i = e, n = "";
				const a = e.indexOf("#");
				if (-1 !== a && (i = e.slice(0, a), n = e.slice(a), !i)) return n;
				const [c, ...l] = i.split("?");
				return c + "/" + (l.length > 0 ? `?${l.join("?")}` : "") + n;
			}
			...
			function pathe_M_eThtNZ_normalizeWindowsPath(e = "") {
				return e ? e.replace(/\\/g, "/").replace(Ke, (e) => e.toUpperCase()) : e;
			}
			const He = /^[/\\]{2}/, ze = /^[/\\](?![/\\])|^[/\\]{2}(?!\.)|^[A-Za-z]:[/\\]/, Je = /^[A-Za-z]:$/, Ye = /.(\.[^./]+|\.)$/, pathe_M_eThtNZ_normalize = function(e) {
				if (0 === e.length) return ".";
				const t = (e = pathe_M_eThtNZ_normalizeWindowsPath(e)).match(He), i = isAbsolute(e), n = "/" === e[e.length - 1];
				return 0 === (e = normalizeString(e, !i)).length ? i ? "/" : n ? "./" : "." : (n && (e += "/"), Je.test(e) && (e += "/"), t ? i ? `//${e}` : `//./${e}` : i && !isAbsolute(e) ? `/${e}` : e);
			}, pathe_M_eThtNZ_join = function(...e) {
				let t = "";
				for (const i of e) if (i) if (t.length > 0) {
					const e = "/" === t[t.length - 1], n = "/" === i[0];
					t += e && n ? i.slice(1) : e || n ? i : `/${i}`;
				} else t += i;
			...
			const pathe_M_eThtNZ_resolve = function(...e) {
				let t = "", i = !1;
				for (let n = (e = e.map((e) => pathe_M_eThtNZ_normalizeWindowsPath(e))).length - 1; n >= -1 && !i; n--) {
					const a = n >= 0 ? e[n] : pathe_M_eThtNZ_cwd();
					a && 0 !== a.length && (t = `${a}/${t}`, i = isAbsolute(a));
				}
				return t = normalizeString(t, !i), i && !isAbsolute(t) ? `/${t}` : t.length > 0 ? t : ".";
			};
			function normalizeString(e, t) {
				let i = "", n = 0, a = -1, c = 0, l = null;
				for (let y = 0; y <= e.length; ++y) {
					...
					if ("/" === l) {
						if (a === y - 1 || 1 === c);
							...
							if (i.length < 2 || 2 !== n || "." !== i[i.length - 1] || "." !== i[i.length - 2]) {
								if (i.length > 2) {
									const e = i.lastIndexOf("/");
									-1 === e ? (i = "", n = 0) : (i = i.slice(0, e), n = i.length - 1 - i.lastIndexOf("/")), a = y, c = 0;
									continue;
								}
								if (i.length > 0) {
									i = "", n = 0, a = y, c = 0;
							...
							t && (i += i.length > 0 ? "/.." : "..", n = 2);
						} else i.length > 0 ? i += `/${e.slice(a + 1, y)}` : i = e.slice(a + 1, y), n = y - a - 1;
						a = y, c = 0;
					} else "." === l && -1 !== c ? ++c : c = -1;
				}
				return i;
			...
			const isAbsolute = function(e) {
				...
				return 1 === t.length && Je.test(t[0]) && (t[0] += "/"), t.join("/") || (isAbsolute(e) ? "/" : ".");
			...
			function createError(e, t, i) {
				return ct.set(e, t), function(e, t) {
					return NodeError;
					function NodeError(...i) {
						const n = Error.stackTraceLimit;
						isErrorStackTraceLimitWritable() && (Error.stackTraceLimit = 0);
						const a = new e();
						isErrorStackTraceLimitWritable() && (Error.stackTraceLimit = n);
						const c = function(e, t, i) {
							const n = ct.get(e);
							if (Ze.ok(void 0 !== n, "expected `message` to be found"), "function" == typeof n) return Ze.ok(n.length <= t.length, `Code: ${e}; The provided arguments length (${t.length}) does not match the required ones (${n.length}).`), Reflect.apply(n, i, t);
							const a = /%[dfijoOs]/g;
							let c = 0;
							for (; null !== a.exec(n);) c++;
							return Ze.ok(c === t.length, `Code: ${e}; The provided arguments length (${t.length}) does not match the required ones (${c}).`), 0 === t.length ? n : (t.unshift(n), Reflect.apply(it.format, null, t));
						}(t, i, a);
			...
			function isErrorStackTraceLimitWritable() {
				...
				return void 0 === e ? Object.isExtensible(Error) : rt.call(e, "writable") && void 0 !== e.writable ? e.writable : void 0 !== e.set;
			}
			ot.ERR_INVALID_ARG_TYPE = createError("ERR_INVALID_ARG_TYPE", (e, t, i) => {
				Ze.ok("string" == typeof e, "'name' must be a string"), Array.isArray(t) || (t = [t]);
				let n = "The ";
				if (e.endsWith(" argument")) n += `${e} `;
				else {
				...
				n += "must be ";
				const a = [], c = [], l = [];
				for (const e of t) Ze.ok("string" == typeof e, "All expected entries have to be of type string"), at.has(e) ? a.push(e.toLowerCase()) : null === nt.exec(e) ? (Ze.ok("object" !== e, "The value \"object\" should be written as \"Object\""), l.push(e)) : c.push(e);
				if (c.length > 0) {
					const e = a.indexOf("object");
					-1 !== e && (a.slice(e, 1), c.push("Object"));
				}
				return a.length > 0 && (n += `${a.length > 1 ? "one of type" : "of type"} ${formatList(a, "or")}`, (c.length > 0 || l.length > 0) && (n += " or ")), c.length > 0 && (n += `an instance of ${formatList(c, "or")}`, l.length > 0 && (n += " or ")), l.length > 0 && (l.length > 1 ? n += `one of ${formatList(l, "or")}` : (l[0].toLowerCase() !== l[0] && (n += "an "), n += `${l[0]}`)), n += `. Received ${function(e) {
					if (null == e) return String(e);
					if ("function" == typeof e && e.name) return `function ${e.name}`;
					if ("object" == typeof e) return e.constructor && e.constructor.name ? `an instance of ${e.constructor.name}` : `${(0, it.inspect)(e, { depth: -1 })}`;
					let t = (0, it.inspect)(e, { colors: !1 });
					t.length > 28 && (t = `${t.slice(0, 25)}...`);
					return `type ${typeof e} (${t})`;
				}(i)}`, n;
			}, TypeError), ot.ERR_INVALID_MODULE_SPECIFIER = createError("ERR_INVALID_MODULE_SPECIFIER", (e, t, i = void 0) => `Invalid module "${e}" ${t}${i ? ` imported from ${i}` : ""}`, TypeError), ot.ERR_INVALID_PACKAGE_CONFIG = createError("ERR_INVALID_PACKAGE_CONFIG", (e, t, i) => `Invalid package config ${e}${t ? ` while importing ${t}` : ""}${i ? `. ${i}` : ""}`, Error), ot.ERR_INVALID_PACKAGE_TARGET = createError("ERR_INVALID_PACKAGE_TARGET", (e, t, i, n = !1, a = void 0) => {
				const c = "string" == typeof i && !n && i.length > 0 && !i.startsWith("./");
				return "." === t ? (Ze.ok(!1 === n), `Invalid "exports" main target ${JSON.stringify(i)} defined in the package config ${e}package.json${a ? ` imported from ${a}` : ""}${c ? "; targets must start with \"./\"" : ""}`) : `Invalid "${n ? "imports" : "exports"}" target ${JSON.stringify(i)} defined for '${t}' in the package config ${e}package.json${a ? ` imported from ${a}` : ""}${c ? "; targets must start with \"./\"" : ""}`;
			}, Error), ot.ERR_MODULE_NOT_FOUND = createError("ERR_MODULE_NOT_FOUND", (e, t, i = !1) => `Cannot find ${i ? "module" : "package"} '${e}' imported from ${t}`, Error), ot.ERR_NETWORK_IMPORT_DISALLOWED = createError("ERR_NETWORK_IMPORT_DISALLOWED", "import of '%s' by %s is not supported: %s", Error), ot.ERR_PACKAGE_IMPORT_NOT_DEFINED = createError("ERR_PACKAGE_IMPORT_NOT_DEFINED", (e, t, i) => `Package import specifier "${e}" is not defined${t ? ` in package ${t}package.json` : ""} imported from ${i}`, TypeError), ot.ERR_PACKAGE_PATH_NOT_EXPORTED = createError("ERR_PACKAGE_PATH_NOT_EXPORTED", (e, t, i = void 0) => "." === t ? `No "exports" main defined in ${e}package.json${i ? ` imported from ${i}` : ""}` : `Package subpath '${t}' is not defined by "exports" in ${e}package.json${i ? ` imported from ${i}` : ""}`, Error), ot.ERR_UNSUPPORTED_DIR_IMPORT = createError("ERR_UNSUPPORTED_DIR_IMPORT", "Directory import '%s' is not supported resolving ES modules imported from %s", Error), ot.ERR_UNSUPPORTED_RESOLVE_REQUEST = createError("ERR_UNSUPPORTED_RESOLVE_REQUEST", "Failed to resolve module specifier \"%s\" from \"%s\": Invalid relative URL or base scheme is not hierarchical.", TypeError), ot.ERR_UNKNOWN_FILE_EXTENSION = createError("ERR_UNKNOWN_FILE_EXTENSION", (e, t) => `Unknown file extension "${e}" for ${t}`, TypeError), ot.ERR_INVALID_ARG_VALUE = createError("ERR_INVALID_ARG_VALUE", (e, t, i = "is invalid") => {
				let n = (0, it.inspect)(t);
				n.length > 128 && (n = `${n.slice(0, 128)}...`);
				return `The ${e.includes(".") ? "property" : "argument"} '${e}' ${i}. Received ${n}`;
			}, TypeError);
			const lt = function(e) {
			...
			function read(e, { base: t, specifier: i }) {
				...
				let a;
				try {
					a = $e.readFileSync(et.toNamespacedPath(e), "utf8");
				} catch (e) {
					const t = e;
				...
				if (void 0 !== a) {
					...
					try {
						...
						const a = n, c = new ut(e, (t ? `"${i}" from ` : "") + (0, Qe.fileURLToPath)(t || i), a.message);
						throw c.cause = a, c;
					}
					c.exists = !0, pt.call(n, "name") && "string" == typeof n.name && (c.name = n.name), pt.call(n, "main") && "string" == typeof n.main && (c.main = n.main), pt.call(n, "exports") && (c.exports = n.exports), pt.call(n, "imports") && (c.imports = n.imports), !pt.call(n, "type") || "commonjs" !== n.type && "module" !== n.type || (c.type = n.type);
				}
				return dt.set(e, c), c;
			}
			function getPackageScopeConfig(e) {
				...
				for (;;) {
					...
					const i = read((0, Qe.fileURLToPath)(t), { specifier: e });
					if (i.exists) return i;
					const n = t;
					if (t = new URL("../package.json", t), t.pathname === n.pathname) break;
				}
				return {
					pjsonPath: (0, Qe.fileURLToPath)(t),
					exists: !1,
					type: "none"
				};
			}
			...
			const xt = {
				...
				"file:": function(e, t, i) {
					...
					if (a) return a;
					if (i) return;
					throw new ft(n, (0, Qe.fileURLToPath)(e));
				},
			...
			function emitInvalidSegmentDeprecation(e, t, i, n, a, c, l) {
				...
				const y = (0, Qe.fileURLToPath)(n), E = null !== Vt.exec(l ? e : t);
				Xe.emitWarning(`Use of deprecated ${E ? "double slash" : "leading or trailing slash matching"} resolving "${e}" for module request "${t}" ${t === i ? "" : `matched to "${i}" `}in the "${a ? "imports" : "exports"}" field module resolution of the package at ${y}${c ? ` imported from ${(0, Qe.fileURLToPath)(c)}` : ""}.`, "DeprecationWarning", "DEP0166");
			}
			function emitLegacyIndexDeprecation(e, t, i, n) {
				if (Xe.noDeprecation) return;
				if ("module" !== function(e, t) {
					const i = e.protocol;
					return mt.call(xt, i) && xt[i](e, t, !0) || null;
				}(e, { parentURL: i.href })) return;
				const c = (0, Qe.fileURLToPath)(e.href), l = (0, Qe.fileURLToPath)(new URL(".", t)), y = (0, Qe.fileURLToPath)(i);
				n ? et.resolve(l, n) !== c && Xe.emitWarning(`Package ${l} has a "main" field set to "${n}", excluding the full filename and extension to the resolved file at "${c.slice(l.length)}", imported from ${y}.\n Automatic extension resolution of the "main" field is deprecated for ES modules.`, "DeprecationWarning", "DEP0151") : Xe.emitWarning(`No "main" or "exports" field defined in the package.json for ${l} resolving the main entry point "${c.slice(l.length)}", imported from ${y}.\nDefault "index" lookups for the main are deprecated for ES modules.`, "DeprecationWarning", "DEP0151");
			}
			function tryStatSync(e) {
				try {
					return (0, $e.statSync)(e);
				} catch {}
			}
			function fileExists(e) {
				const t = (0, $e.statSync)(e, { throwIfNoEntry: !1 }), i = t ? t.isFile() : void 0;
				return null != i && i;
			}
			function legacyMainResolve(e, t, i) {
				let n;
				if (void 0 !== t.main) {
					if (n = new URL(t.main, e), fileExists(n)) return n;
					const a = [
						`./${t.main}.js`,
						`./${t.main}.json`,
						`./${t.main}.node`,
					...
					let c = -1;
					for (; ++c < a.length && (n = new URL(a[c], e), !fileExists(n));) n = void 0;
					if (n) return emitLegacyIndexDeprecation(n, e, i, t.main), n;
				}
				const a = [
					"./index.js",
					"./index.json",
				...
				for (; ++c < a.length && (n = new URL(a[c], e), !fileExists(n));) n = void 0;
				if (n) return emitLegacyIndexDeprecation(n, e, i, t.main), n;
				throw new wt((0, Qe.fileURLToPath)(new URL(".", e)), (0, Qe.fileURLToPath)(i));
			}
			function exportsNotFound(e, t, i) {
				return new St((0, Qe.fileURLToPath)(new URL(".", t)), e, i && (0, Qe.fileURLToPath)(i));
			}
			function invalidPackageTarget(e, t, i, n, a) {
				return t = "object" == typeof t && null !== t ? JSON.stringify(t, null, "") : `${t}`, new kt((0, Qe.fileURLToPath)(new URL(".", i)), e, t, n, a && (0, Qe.fileURLToPath)(a));
			}
			function resolvePackageTargetString(e, t, i, n, a, c, l, y, E) {
				if ("" !== t && !c && "/" !== e[e.length - 1]) throw invalidPackageTarget(i, e, n, l, a);
				if (!e.startsWith("./")) {
					if (l && !e.startsWith("../") && !e.startsWith("/")) {
						let i = !1;
						try {
							new URL(e), i = !0;
						} catch {}
						if (!i) return packageResolve(c ? _t.call(Nt, e, () => t) : e + t, n, E);
					}
					throw invalidPackageTarget(i, e, n, l, a);
				}
				if (null !== At.exec(e.slice(2))) {
					if (null !== Pt.exec(e.slice(2))) throw invalidPackageTarget(i, e, n, l, a);
					if (!y) {
						const y = c ? i.replace("*", () => t) : i + t;
						emitInvalidSegmentDeprecation(c ? _t.call(Nt, e, () => t) : e, y, i, n, l, a, !0);
					}
				}
				const w = new URL(e, n), C = w.pathname, S = new URL(".", n).pathname;
				if (!C.startsWith(S)) throw invalidPackageTarget(i, e, n, l, a);
				if ("" === t) return w;
				if (null !== At.exec(t)) {
					const E = c ? i.replace("*", () => t) : i + t;
					if (null === Pt.exec(t)) {
						if (!y) emitInvalidSegmentDeprecation(c ? _t.call(Nt, e, () => t) : e, E, i, n, l, a, !1);
					} else (function(e, t, i, n, a) {
						throw new Et(e, `request is not a valid match in pattern "${t}" for the "${n ? "imports" : "exports"}" resolution of ${(0, Qe.fileURLToPath)(i)}`, a && (0, Qe.fileURLToPath)(a));
					})(E, i, n, l, a);
				}
				return c ? new URL(_t.call(Nt, w.href, () => t)) : new URL(t, w);
			}
			function isArrayIndex(e) {
				const t = Number(e);
				return `${t}` === e && t >= 0 && t < 4294967295;
			}
			function resolvePackageTarget(e, t, i, n, a, c, l, y, E) {
				if ("string" == typeof t) return resolvePackageTargetString(t, i, n, e, a, c, l, y, E);
				if (Array.isArray(t)) {
					const w = t;
					...
					for (; ++S < w.length;) {
						...
						let I;
						try {
							I = resolvePackageTarget(e, t, i, n, a, c, l, y, E);
						} catch (e) {
							if (C = e, "ERR_INVALID_PACKAGE_TARGET" === e.code) continue;
							throw e;
						}
						if (void 0 !== I) {
							if (null !== I) return I;
				...
				if ("object" == typeof t && null !== t) {
					const w = Object.getOwnPropertyNames(t);
					let C = -1;
					for (; ++C < w.length;) if (isArrayIndex(w[C])) throw new bt((0, Qe.fileURLToPath)(e), a, "\"exports\" cannot contain numeric property keys.");
					for (C = -1; ++C < w.length;) {
						const S = w[C];
						if ("default" === S || E && E.has(S)) {
							const w = resolvePackageTarget(e, t[S], i, n, a, c, l, y, E);
				...
				throw invalidPackageTarget(n, t, e, l, a);
			}
			function emitTrailingSlashPatternDeprecation(e, t, i) {
				if (Xe.noDeprecation) return;
				const n = (0, Qe.fileURLToPath)(t);
				Dt.has(n + "|" + e) || (Dt.add(n + "|" + e), Xe.emitWarning(`Use of deprecated trailing slash pattern mapping "${e}" in the "exports" field module resolution of the package at ${n}${i ? ` imported from ${(0, Qe.fileURLToPath)(i)}` : ""}. Mapping specifiers ending in "/" is no longer supported.`, "DeprecationWarning", "DEP0155"));
			}
			function packageExportsResolve(e, t, i, n, a) {
				let c = i.exports;
				if (function(e, t, i) {
					...
					for (; ++l < n.length;) {
						const e = n[l], y = "" === e || "." !== e[0];
						if (0 === c++) a = y;
						else if (a !== y) throw new bt((0, Qe.fileURLToPath)(t), i, "\"exports\" cannot contain some keys starting with '.' and some not. The exports object must either be an object of package subpath keys or an object of main entry condition name keys only.");
					}
					return a;
				}(c, e, n) && (c = { ".": c }), Rt.call(c, t) && !t.includes("*") && !t.endsWith("/")) {
					const i = resolvePackageTarget(e, c[t], "", t, n, !1, !1, !1, a);
					if (null == i) throw exportsNotFound(t, e, n);
					return i;
				}
				let l = "", y = "";
				const E = Object.getOwnPropertyNames(c);
				let w = -1;
				for (; ++w < E.length;) {
					const i = E[w], a = i.indexOf("*");
					if (-1 !== a && t.startsWith(i.slice(0, a))) {
						t.endsWith("/") && emitTrailingSlashPatternDeprecation(t, e, n);
						const c = i.slice(a + 1);
						t.length >= i.length && t.endsWith(c) && 1 === patternKeyCompare(l, i) && i.lastIndexOf("*") === a && (l = i, y = t.slice(a, t.length - c.length));
					}
				}
				if (l) {
					const i = resolvePackageTarget(e, c[l], y, l, n, !0, !1, t.endsWith("/"), a);
					if (null == i) throw exportsNotFound(t, e, n);
					return i;
				}
				throw exportsNotFound(t, e, n);
			}
			function patternKeyCompare(e, t) {
				const i = e.indexOf("*"), n = t.indexOf("*"), a = -1 === i ? e.length : i + 1, c = -1 === n ? t.length : n + 1;
				return a > c ? -1 : c > a || -1 === i ? 1 : -1 === n || e.length > t.length ? -1 : t.length > e.length ? 1 : 0;
			}
			function packageImportsResolve(e, t, i) {
				if ("#" === e || e.startsWith("#/") || e.endsWith("/")) throw new Et(e, "is not a valid internal imports specifier name", (0, Qe.fileURLToPath)(t));
				let n;
				const a = getPackageScopeConfig(t);
				if (a.exists) {
					n = (0, Qe.pathToFileURL)(a.pjsonPath);
					const c = a.imports;
					if (c) if (Rt.call(c, e) && !e.includes("*")) {
						const a = resolvePackageTarget(n, c[e], "", e, t, !1, !0, !1, i);
						if (null != a) return a;
					} else {
						let a = "", l = "";
						const y = Object.getOwnPropertyNames(c);
						let E = -1;
						for (; ++E < y.length;) {
							const t = y[E], i = t.indexOf("*");
							if (-1 !== i && e.startsWith(t.slice(0, -1))) {
								const n = t.slice(i + 1);
								e.length >= t.length && e.endsWith(n) && 1 === patternKeyCompare(a, t) && t.lastIndexOf("*") === i && (a = t, l = e.slice(i, e.length - n.length));
							}
						}
						if (a) {
							const e = resolvePackageTarget(n, c[a], l, a, t, !0, !0, !1, i);
							if (null != e) return e;
						}
					}
				}
				throw function(e, t, i) {
					return new Ct(e, t && (0, Qe.fileURLToPath)(new URL(".", t)), (0, Qe.fileURLToPath)(i));
				}(e, n, t);
			}
			function packageResolve(e, t, i) {
				if (Be.builtinModules.includes(e)) return new URL("node:" + e);
				const { packageName: n, packageSubpath: a, isScoped: c } = function(e, t) {
					let i = e.indexOf("/"), n = !0, a = !1;
					"@" === e[0] && (a = !0, -1 === i || 0 === e.length ? n = !1 : i = e.indexOf("/", i + 1));
					const c = -1 === i ? e : e.slice(0, i);
					if (null !== Lt.exec(c) && (n = !1), !n) throw new Et(e, "is not a valid package name", (0, Qe.fileURLToPath)(t));
					return {
						packageName: c,
				...
				let y, E = new URL("./node_modules/" + n + "/package.json", t), w = (0, Qe.fileURLToPath)(E);
				do {
					const l = tryStatSync(w.slice(0, -13));
					if (!l || !l.isDirectory()) {
						y = w, E = new URL((c ? "../../../../node_modules/" : "../../../node_modules/") + n + "/package.json", E), w = (0, Qe.fileURLToPath)(E);
						continue;
					}
					const C = read(w, {
						base: t,
					...
					return void 0 !== C.exports && null !== C.exports ? packageExportsResolve(E, a, C, t, i) : "." === a ? legacyMainResolve(E, C, t) : new URL(a, E);
				} while (w.length !== y.length);
			}
			function moduleResolve(e, t, i, n) {
				void 0 === i && (i = getConditionsSet());
				const a = t.protocol, c = "data:" === a || "http:" === a || "https:" === a;
				let l;
				if (function(e) {
				...
				else if ("file:" === a && "#" === e[0]) l = packageImportsResolve(e, t, i);
				else try {
					l = new URL(e);
				} catch (n) {
					if (c && !Be.builtinModules.includes(e)) {
						const i = new Tt(e, t);
						throw i.cause = n, i;
					}
					l = packageResolve(e, t, i);
				}
				return Ze.ok(void 0 !== l, "expected to be defined"), "file:" !== l.protocol ? l : function(e, t) {
					if (null !== Ot.exec(e.pathname)) throw new Et(e.pathname, "must not include encoded \"/\" or \"\\\" characters", (0, Qe.fileURLToPath)(t));
					let i;
					try {
						i = (0, Qe.fileURLToPath)(e);
					} catch (i) {
						const n = i;
						throw Object.defineProperty(n, "input", { value: String(e) }), Object.defineProperty(n, "module", { value: String(t) }), n;
					}
					const n = tryStatSync(i.endsWith("/") ? i.slice(-1) : i);
					if (n && n.isDirectory()) {
						const n = new It(i, (0, Qe.fileURLToPath)(t));
						throw n.url = String(e), n;
					}
					if (!n || !n.isFile()) {
						const n = new wt(i || e.pathname, t && (0, Qe.fileURLToPath)(t), !0);
						throw n.url = String(e), n;
					}
					{
			...
			function fileURLToPath(e) {
				return "string" != typeof e || e.startsWith("file://") ? normalizeSlash((0, Qe.fileURLToPath)(e)) : normalizeSlash(e);
			}
			...
			function _resolve(e, t = {}) {
				...
				if (st.has(e)) return "node:" + e;
				if (e.startsWith("file://") && (e = fileURLToPath(e)), isAbsolute(e)) try {
					if ((0, $e.statSync)(e).isFile()) return pathToFileURL(e);
				} catch (e) {
					if ("ENOENT" !== e?.code) throw e;
				}
				const i = t.conditions ? new Set(t.conditions) : Ut, n = (Array.isArray(t.url) ? t.url : [t.url]).filter(Boolean).map((e) => new URL(function(e) {
					return "string" != typeof e && (e = e.toString()), /(?:node|data|http|https|file):/.test(e) ? e : st.has(e) ? "node:" + e : "file://" + encodeURI(normalizeSlash(e));
				}(e.toString())));
				0 === n.length && n.push(new URL(pathToFileURL(process.cwd())));
				const a = [...n];
				for (const e of n) "file:" === e.protocol && a.push(new URL("./", e), new URL(dist_joinURL(e.pathname, "_index.js"), e), new URL("node_modules", e));
				let c;
				for (const n of a) {
					if (c = _tryModuleResolve(e, n, i), c) break;
					for (const a of ["", "/index"]) {
						for (const l of t.extensions || Mt) if (c = _tryModuleResolve(dist_joinURL(e, a) + l, n, i), c) break;
						if (c) break;
					}
					if (c) break;
				}
				if (!c) {
					const t = /* @__PURE__ */ new Error(`Cannot find module ${e} imported from ${a.join(", ")}`);
					throw t.code = "ERR_MODULE_NOT_FOUND", t;
				}
				return pathToFileURL(c);
			}
			...
			function hasESMSyntax(e, t = {}) {
				return t.stripComments && (e = e.replace(Bt, "")), Ft.test(e);
			}
			...
			function normalizeAliases(e) {
				...
				for (const e in t) for (const i in t) i === e || e.startsWith(i) || t[e]?.startsWith(i) && $t.has(t[e][i.length]) && (t[e] = t[i] + t[e].slice(i.length));
				return Object.defineProperty(t, qt, {
					value: !0,
					enumerable: !1
				}), t;
			}
			...
			const Zt = function() {
				let e = zt.AI_AGENT;
				if (e) return { name: e.toLowerCase() };
				for (let [e, t] of Qt) for (let i of t) if ("string" == typeof i ? zt[i] : i()) return { name: e };
				return {};
			}(), Xt = (Zt.name, Zt.name, [
				["APPVEYOR"],
				[
				...
				for (let e of Xt) if (zt[e[1] || e[0]]) return {
			...
			const ni = ("production" === Yt || zt.MODE, "dev" === Yt || "development" === Yt || zt.MODE, zt.MINIMAL, /^win/i.test(ti)), ai = (/^linux/i.test(ti), /^darwin/i.test(ti), !zt.NO_COLOR && (zt.FORCE_COLOR || (si || ni) && zt.TERM), (Jt.versions?.node || "").replace(/^v/, "") || null), oi = (Number(ai?.split(".")[0]), !!Jt?.versions?.node), ci = "Bun" in globalThis, hi = "Deno" in globalThis, li = "fastly" in globalThis, pi = [
			...
			const di = __require("node:tty")?.WriteStream?.prototype?.hasColors?.() ?? !1, base_format = (e, t) => {
				if (!di) return (e) => e;
				const i = `[${e}m`, n = `[${t}m`;
				return (e) => {
					const a = e + "";
					...
					let l = i, y = 0;
					const E = (22 === t ? n : "") + i;
					for (; -1 !== c;) l += a.slice(y, c) + E, y = c + n.length, c = a.indexOf(n, y);
					return l += a.slice(y) + n, l;
				};
			...
			function isDir(e) {
				...
				try {
					return (0, $e.lstatSync)(e).isDirectory();
				} catch {
					return !1;
				}
			}
			function utils_hash(e, t = 8) {
				...
				}() ? Ht().createHash("sha256") : Ht().createHash("md5")).update(e).digest("hex").slice(0, t);
			}
			const _i = {
				true: mi("true"),
				false: gi("false"),
			...
			function debug(e, ...t) {
				...
				const i = process.cwd();
				console.log(yi(["[jiti]", ...t.map((e) => e in _i ? _i[e] : "string" != typeof e ? JSON.stringify(e) : e.replace(i, "."))].join(" ")));
			}
			function jitiInteropDefault(e, t) {
				return e.opts.interopDefault ? function(e) {
					const t = typeof e;
					if (null === e || "object" !== t && "function" !== t) return e;
					const i = e.default, n = typeof i, a = null == i, c = "object" === n || "function" === n;
					if (a && e instanceof Promise) return e;
					const l = "function" === n && "function" !== t, y = c && !(i instanceof Promise), E = /* @__PURE__ */ new Map();
					return new Proxy(e, {
						get(t, n) {
							if (E.has(n)) return E.get(n);
							let c;
							return "__esModule" === n ? c = !0 : "default" === n ? c = a ? e : "function" == typeof i?.default && e.__esModule ? i.default : i : n in t ? c = t[n] : y && (c = i[n], "function" == typeof c && (c = c.bind(i))), E.set(n, c), c;
						},
						apply: l ? (e, t, n) => Reflect.apply(i, t, n) : void 0
					});
				}(t) : t;
			}
			let Ei;
			...
			function jitiResolve(e, t, i) {
				...
				if (e.resolveTsConfigPaths && !i.skipTsConfigPaths) {
					const n = e.resolveTsConfigPaths(t);
					for (const t of n) {
						const n = jitiResolve(e, t, {
							...i,
							try: !0,
							skipTsConfigPaths: !0
						});
				...
				e.alias && (t = function(e, t) {
					...
					for (const [e, n] of Object.entries(t)) {
						...
						if (utils_hasTrailingSlash(i[(utils_hasTrailingSlash(e) ? e.slice(0, -1) : e).length])) return pathe_M_eThtNZ_join(n, i.slice(e.length));
					}
					return i;
				}(t, e.alias));
				let c = i?.parentURL || e.url;
				isDir(c) && (c = pathe_M_eThtNZ_join(c, "_index.js"));
				const l = (i?.async ? [
					i?.conditions,
					["node", "import"],
					["node", "require"]
				...
				for (const a of e.additionalExts) {
					if (n = tryNativeRequireResolve(e, t + a, c, i) || tryNativeRequireResolve(e, t + "/index" + a, c, i), n) return n;
					if ((ki.test(e.filename) || ki.test(e.parentModule?.filename || "") || bi.test(t)) && (n = tryNativeRequireResolve(e, t.replace(bi, ".$1t$2"), c, i), n)) return n;
				}
				if (!i?.try) throw a;
			}
			function tryNativeRequireResolve(e, t, i, n) {
				try {
					return e.nativeRequire.resolve(t, {
						...n,
						paths: [pathe_M_eThtNZ_dirname(fileURLToPath(i)), ...n?.paths || []]
					});
				} catch {}
			}
			...
			function jitiRequire(e, t, i) {
				const n = e.parentCache || {};
				if (t.startsWith("node:")) return nativeImportOrRequire(e, t, i.async);
				if (t.startsWith("file:")) t = (0, Qe.fileURLToPath)(t);
				...
				if (Be.builtinModules.includes(t) || ".pnp.js" === t) return nativeImportOrRequire(e, t, i.async);
				if (e.opts.virtualModules && t in e.opts.virtualModules) {
					debug(e, "[virtual]", t);
					const n = e.opts.virtualModules[t];
					return i.async ? Promise.resolve(jitiInteropDefault(e, n)) : jitiInteropDefault(e, n);
				}
				if (e.opts.tryNative && !e.opts.transformOptions) try {
					if (!(t = jitiResolve(e, t, i)) && i.try) return;
					if (debug(e, "[try-native]", i.async && e.nativeImport ? "[import]" : "[require]", t), i.async && e.nativeImport) return e.nativeImport(t).then((i) => (!1 === e.opts.moduleCache && delete e.nativeRequire.cache[t], jitiInteropDefault(e, i))).catch((n) => (debug(e, `[try-native] Using fallback for ${t} because of an error:`, n), jitiRequire({
						...e,
						opts: {
							...e.opts,
							tryNative: !1
				...
				const a = jitiResolve(e, t, i);
				if (!a && i.try) return;
				const c = extname(a);
				if (".json" === c) {
					debug(e, "[json]", a);
					const t = e.nativeRequire(a);
				...
				if (e.isNativeRe.test(a)) return debug(e, "[native]", i.async ? "[import]" : "[require]", a), nativeImportOrRequire(e, a, i.async);
				if (n[a]) return jitiInteropDefault(e, n[a]?.exports);
				if (e.opts.moduleCache) {
					const t = e.nativeRequire.cache[a];
					if (t?.loaded) return jitiInteropDefault(e, t.exports);
				}
				return eval_evalModule(e, (0, $e.readFileSync)(a, "utf8"), {
					id: t,
					filename: a,
					ext: c,
					cache: n,
			...
			function nativeImportOrRequire(e, t, i) {
				return i && e.nativeImport ? e.nativeImport(function(e) {
					return ni && isAbsolute(e) ? pathToFileURL(e) : e;
			...
			function getCache(e, t, i) {
				...
				const n = ` /* v${Ti}-${utils_hash(t.source, 16)} */\n`;
				let a = `${basename(pathe_M_eThtNZ_dirname(t.filename))}-${function(e) {
					const t = e.split(Wt).pop();
					if (!t) return;
					const i = t.lastIndexOf(".");
					return i <= 0 ? t : t.slice(0, i);
				}(t.filename)}` + (e.opts.sourceMaps ? "+map" : "") + (t.interopDefault ? ".i" : "") + `.${utils_hash(t.filename)}` + (t.async ? ".mjs" : ".cjs");
				t.jsx && t.filename.endsWith("x") && (a += "x");
				const c = e.opts.fsCache, l = pathe_M_eThtNZ_join(c, a);
				if (!e.opts.rebuildFsCache && (0, $e.existsSync)(l)) {
					const i = (0, $e.readFileSync)(l, "utf8");
					if (i.endsWith(n)) return debug(e, "[cache]", "[hit]", t.filename, "~>", l), i;
				}
				debug(e, "[cache]", "[miss]", t.filename);
				const y = i();
				return y.includes("__JITI_ERROR__") || ((0, $e.writeFileSync)(l, y + n, "utf8"), debug(e, "[cache]", "[store]", t.filename, "~>", l)), y;
			}
			function prepareCacheDir(t) {
				if (!0 === t.opts.fsCache && (t.opts.fsCache = function(t) {
					...
					if (i && (0, $e.existsSync)(i)) return pathe_M_eThtNZ_join(i, ".cache/jiti");
					let n = (0, e.tmpdir)();
					if (process.env.TMPDIR && n === process.cwd() && !process.env.JITI_RESPECT_TMPDIR_ENV) {
						const t = process.env.TMPDIR;
						delete process.env.TMPDIR, n = (0, e.tmpdir)(), process.env.TMPDIR = t;
					}
					return pathe_M_eThtNZ_join(n, "jiti");
				}(t)), t.opts.fsCache) try {
					if ((0, $e.mkdirSync)(t.opts.fsCache, { recursive: !0 }), !function(e) {
						try {
							return (0, $e.accessSync)(e, $e.constants.W_OK), !0;
						} catch {
							return !1;
						}
			...
			function eval_evalModule(t, i, n = {}) {
				const a = n.id || (n.filename ? basename(n.filename) : `_jitiEval.${n.ext || (n.async ? "mjs" : "js")}`), c = n.filename || jitiResolve(t, a, { async: n.async }), l = n.ext || extname(c), y = n.cache || t.parentCache || {}, E = /\.[cm]?tsx?$/.test(l), w = ".mjs" === l || ".js" === l && "module" === function(e) {
					for (; e && "." !== e && "/" !== e;) {
						e = pathe_M_eThtNZ_join(e, "..");
						try {
							const t = (0, $e.readFileSync)(pathe_M_eThtNZ_join(e, "package.json"), "utf8");
							try {
								return JSON.parse(t);
							} catch {}
							break;
				...
				}(c)?.type, C = ".cjs" === l, S = n.forceTranspile ?? (!C && !(w && n.async) && (E || w || t.isTransformRe.test(c) || hasESMSyntax(i))), I = Ci.performance.now();
				if (S) {
					i = transform(t, {
						filename: c,
						source: i,
					...
					const e = Math.round(1e3 * (Ci.performance.now() - I)) / 1e3;
					debug(t, "[transpile]", n.async ? "[esm]" : "[cjs]", c, `(${e}ms)`);
				} else {
					if (debug(t, "[native]", n.async ? "[import]" : "[require]", c), n.async) return Promise.resolve(nativeImportOrRequire(t, c, n.async)).catch((e) => (debug(t, "Native import error:", e), debug(t, "[fallback]", c), eval_evalModule(t, i, {
						...n,
						forceTranspile: !0
					})));
					try {
						return nativeImportOrRequire(t, c, n.async);
					} catch (e) {
						debug(t, "Native require error:", e), debug(t, "[fallback]", c), i = transform(t, {
							filename: c,
							source: i,
							ts: E,
							async: n.async ?? !1,
				...
				const N = new Be.Module(c);
				N.filename = c, t.parentModule && (N.parent = t.parentModule, Array.isArray(t.parentModule.children) && !t.parentModule.children.includes(N) && t.parentModule.children.push(N));
				const O = createJiti(c, t.opts, {
					parentModule: N,
					parentCache: y,
					nativeImport: t.nativeImport,
					onError: t.onError,
					createRequire: t.createRequire
				}, !0);
				let j;
				N.require = O, N.path = pathe_M_eThtNZ_dirname(c), N.paths = Be.Module._nodeModulePaths(N.path), y[c] = N, t.opts.moduleCache && (t.nativeRequire.cache[c] = N);
				const F = function(e, t) {
					return `(${t?.async ? "async " : ""}function (exports, require, module, __filename, __dirname, jitiImport, jitiESMResolve) { ${e}\n});`;
				}(i, { async: n.async });
				try {
					j = Ii().runInThisContext(F, {
						filename: c,
						lineOffset: 0,
						displayErrors: !1
					});
				} catch (i) {
					"SyntaxError" === i.name && n.async && t.nativeImport ? (debug(t, "[esm]", "[import]", "[fallback]", c), j = function(t, i, n, a, c) {
						const l = `export default ${i}`, y = c ? void 0 : `data:text/javascript;base64,${Buffer.from(l).toString("base64")}`;
						return (...i) => {
							let c;
							const importViaTempFile = () => (c = function(t, i) {
								const n = pathe_M_eThtNZ_join((0, e.tmpdir)(), "jiti-esm");
								try {
									(0, $e.mkdirSync)(n, { recursive: !0 });
								} catch {}
								const a = pathe_M_eThtNZ_join(n, `${basename(i, extname(i))}-${Date.now()}-${Math.random().toString(36).slice(2)}.mjs`);
								return (0, $e.writeFileSync)(a, t), a;
							}(l, n), debug(t, "[esm]", "[tempfile]", c), a(pathToFileURL(c)));
							return (y ? a(y).catch((e) => {
								if ("ENAMETOOLONG" !== e?.code) throw e;
								return importViaTempFile();
							}) : importViaTempFile()).then((e) => e.default(...i)).finally(() => {
								c && (0, wi.unlink)(c).catch(() => {});
							});
						};
					}(t, F, c, t.nativeImport, t.opts.esmEvalTempFile)) : (t.opts.moduleCache && delete t.nativeRequire.cache[c], t.onError(i));
				}
				let B;
				try {
					B = j(N.exports, N.require, N, N.filename, pathe_M_eThtNZ_dirname(N.filename), O.import, O.esmResolve);
				} catch (e) {
					t.opts.moduleCache && delete t.nativeRequire.cache[c], t.onError(e);
				}
				function next() {
					...
					N.loaded = !0;
					return jitiInteropDefault(t, N.exports);
				}
				return n.async ? Promise.resolve(B).then(next) : next();
			}
			const Ri = "win32" === (0, e.platform)();
			function createJiti(e, t = {}, i, n = !1) {
				const a = n ? t : function(e) {
					const t = {
				...
				"string" == typeof e && e.startsWith("file://") && (e = fileURLToPath(e));
				...
				const y = [
					...
					"jiti",
					...a.nativeModules || []
				], E = new RegExp(`node_modules/(${y.map((e) => escapeStringRegexp(e)).join("|")})/`), w = [...a.transformModules || []], C = new RegExp(`node_modules/(${w.map((e) => escapeStringRegexp(e)).join("|")})/`);
				e || (e = process.cwd()), !n && isDir(e) && (e = pathe_M_eThtNZ_join(e, "_index.js"));
				const S = pathToFileURL(e), I = [...a.extensions].filter((e) => ".js" !== e), N = i.createRequire(Ri ? e.replace(/\//g, "\\") : e), O = {
					filename: e,
					url: S,
					opts: a,
					alias: c,
					resolveTsConfigPaths: l,
					nativeModules: y,
					transformModules: w,
					isNativeRe: E,
					isTransformRe: C,
				...
				n || debug(O, "[init]", ...[
					["version:", Gt.rE],
					["module-cache:", a.moduleCache],
					["fs-cache:", a.fsCache],
					["rebuild-fs-cache:", a.rebuildFsCache],
					["interop-defaults:", a.interopDefault]
				].flat()), n || prepareCacheDir(O);
				return Object.assign(function(e) {
					return jitiRequire(O, e, { async: !1 });
				}, {
					cache: a.moduleCache ? N.cache : Object.create(null),
					extensions: N.extensions,
					main: N.main,
					options: a,
					resolve: Object.assign(function(e, t) {
						return jitiResolve(O, e, {
							...t,
							async: !1
						});
					}, { paths: N.resolve.paths }),
					transform: (e) => transform(O, e),
					evalModule: (e, t) => eval_evalModule(O, e, t),
					async import(e, t) {
						const i = await jitiRequire(O, e, {
							...t,
							async: !0
						});
