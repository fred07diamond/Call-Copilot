...
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/deploy/route-discovery.js
var _fs;
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/server/framework-request-handler.js
...
function registerMiddleware(nitroApp, path, handler) {
	...
	const middleware = async (event, next) => {
		...
		try {
			...
			if (status >= 500) import("./sentry-CHiAaf-o.js").then(({ captureRouteError, isServerSentryEnabled }) => {
...
async function bootstrapDefaultPlugins(nitroApp) {
	...
	try {
		...
		const serverModule = await import("./server-GW7LBbhF.js");
		const terminalModule = await import("./terminal-plugin-CZ9Ri553.js").then((n) => n.r);
		const integrationsModule = await import("./plugin-DCFPpglz.js");
		const orgModule = await import("./plugin-70A7Kkbm.js");
		const onboardingModule = await import("./plugin-BCCWKLlq.js");
		...
		let workspaceImpls = {};
		try {
			const { getWorkspaceCoreExports } = await import("./workspace-core-Cw64giB7.js");
