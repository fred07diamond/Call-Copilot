...
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/server/cli-capture.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/server/action-discovery.js
...
async function autoDiscoverActions(from) {
	...
	if (Object.keys(registry).length === 0 && from) try {
		...
		} else registryPath = nodePath.resolve(from, "../.generated/actions-registry.js");
		const mod = await import(
			/* @vite-ignore */
			registryPath
);
...
async function mergeCoreSharingActions(registry) {
	const entries = [
		["share-resource", () => import("./share-resource-ng7P8Ozb.js")],
		["unshare-resource", () => import("./unshare-resource-B0Jq6x9n.js")],
		["list-resource-shares", () => import("./list-resource-shares-CQQ2o0g0.js")],
		["set-resource-visibility", () => import("./set-resource-visibility-BauyF8RD.js")]
	];
