...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/scripts/parse-args.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/scripts/utils.js
...
function loadEnv(envPath) {
	...
	if (workspaceRoot) {
		...
		if (fs.existsSync(wsEnv) && wsEnv !== appEnv) import_main.default.config({
			path: wsEnv,
			quiet: true
		});
	}
...
function findWorkspaceRoot(startDir) {
	...
	for (let i = 0; i < 20; i++) {
		...
		if (fs.existsSync(pkgPath)) try {
			const wsCore = JSON.parse(fs.readFileSync(pkgPath, "utf-8"))?.["agent-native"]?.workspaceCore;
			if (typeof wsCore === "string" && wsCore.length > 0) return dir;
		} catch {}
...
//#endregion
export { parseArgs as i, findWorkspaceRoot as n, loadEnv as r, fail as t };
