...
import { a as getRequestRunContext, i as getRequestOrgId, o as getRequestUserEmail } from "./request-context-BQ-cTIMw.js";
import { a as isDeployCredentialFallbackAllowed, o as readDeployCredentialEnv } from "./credential-provider-DYZUZb4W.js";
import { d as EngineError, l as startRun, o as getActiveRunForThreadAsync, u as subscribeToRun } from "./run-manager-yEeZIxib.js";
import { i as getStoredModelForEngine, l as resolveEngine } from "./registry-B0ticQi1.js";
import { t as registerBuiltinEngines } from "./builtin-BXE1_lKc.js";
import { c as normalizeReasoningEffortForModel, s as isReasoningEffort } from "./model-config-u1v2yA93.js";
import { i as PROVIDER_TO_ENV } from "./provider-env-vars-DITfSWnb.js";
import { a as userFacingLlmCredentialError } from "./credential-errors-4qhli1oh.js";
import "./engine-DqVnItAv.js";
import { n as readAppState } from "./script-helpers-BSzah_dC.js";
import { n as getOrgSetting, r as putOrgSetting, t as deleteOrgSetting } from "./settings-CYkHNmre.js";
import { a as readAppSecret, s as writeAppSecret, t as deleteAppSecret } from "./storage-DSrYNAgc.js";
import { i as readAgentLoopSettings, n as getDefaultMaxIterations, r as normalizeMaxIterations } from "./loop-settings-mhq1rUOi.js";
import { n as isAgentActionStopError } from "./action-BOsFWutU.js";
import { createHash } from "node:crypto";
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/mcp-client/remote-store.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/mcp-client/visibility.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/mcp-client/errors.js
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/mcp-client/manager.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/agent/tool-search.js
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_d8cd0b9ea502c97d2f2b6c28b2fc9a81/node_modules/@agent-native/core/dist/agent/production-agent.js
...
async function getOwnerApiKey(provider, ownerEmail) {
	...
	try {
		const { getSetting } = await import("./store-x1hv_0xb.js");
...
<selection>\n${sel.text}\n</selection>`;
		...
		const filesContextPromise = (async () => {
			...
			if (history.length === 0) try {
				const { resourceListAccessible, SHARED_OWNER, resourceGet } = await import("./store-CjfU7ZK0.js");
				const { getResourceKind, parseCustomAgentProfile, parseRemoteAgentManifest, parseSkillMetadata } = await import("./metadata-BxnFNJ7Y.js").then((n) => n.c);
		...
		startRun(runId, threadId ?? runId, async (send, signal) => {
				...
				const customResponses = (await Promise.allSettled(customAgentRefs.map(async (ref) => {
					...
					try {
						...
						try {
							...
							const { recordUsage } = await import("./store-dZXzdqy-.js");
							await recordUsage({
								ownerEmail,
			...
			if (agentRefs.length > 0 && requestMode !== "plan") {
				const [{ A2AClient, callAgent }, { resolveA2ACallerAuth }] = await Promise.all([import("./client-DoIFGiWA.js").then((n) => n.i), import("./caller-auth-vRcMIm6f.js")]);
			...
			try {
				const { resolveActiveExperimentConfig } = await import("./experiments-Bxz3Z8MA.js");
				if (!ownerEmail) throw new Error("no authenticated user");
			...
			try {
				const { getObservabilityConfig, instrumentAgentLoop } = await import("./traces-Cy5Zkx-G.js");
