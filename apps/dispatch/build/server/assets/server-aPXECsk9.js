...
import { d as appendA2AArtifactLinks, f as buildA2ARecoverableArtifactMessage, l as uploadFile } from "./a2a-continuation-processor-DKnDz58t.js";
import { t as readBody } from "./h3-helpers-CmxO0LxM.js";
import { m as getOrigin, n as autoMountAuth, r as getSession } from "./auth-CvO2kpTD.js";
...
import { C as mergedConfigKey, E as validateRemoteUrl, S as listRemoteServers, T as toHttpServerConfigAsync, _ as attachToolSearch, b as isMcpToolAllowedForRequest, c as createProductionAgentHandler, h as runAgentLoop, i as appendAgentLoopContinuation, o as continuationReasonForResumableError, p as isResumableEngineError, r as actionsToEngineTools, v as McpClientManager, w as removeRemoteServer, x as addRemoteServer, y as formatMcpConnectError } from "./production-agent-DdPrRTBN.js";
...
import { a as markDefaultPluginProvided, i as getH3App, n as awaitBootstrap, o as trackPluginInit } from "./framework-request-handler-UFrmVPec.js";
import "./plugin-BB3ZkRDD.js";
import { r as getOrgContext } from "./context-DeNWRFE0.js";
import { n as discoverAgents } from "./agent-discovery-BcWafB5b.js";
...
import { a as resourceGet, c as resourceListAccessible, d as resourcePut, n as ensurePersonalDefaults, o as resourceGetByPath, r as resourceDelete, s as resourceList, t as SHARED_OWNER, u as resourceMove } from "./store-DnS7XzPK.js";
...
import { d as getBuilderBrowserConnectUrl, g as resolveBuilderBranchProjectId } from "./builder-browser-D8LMt4Ed.js";
...
import { c as collectFinalResponseTextFromAgentEvents, s as buildRuntimeContextPrompt } from "./plugin-BLCn3poL.js";
...
async function createResourceScriptEntries() {
	try {
		const [list, read, write, del, saveMem, delMem] = await Promise.all([
			import("./list-d5j0_8hw.js"),
			import("./read-Dcr5PxLx.js"),
			import("./write-DNQKtkoL.js"),
			import("./delete-BDsXcQ5V.js"),
			import("./save-memory-BaUZts5b.js"),
			import("./delete-memory-DNCDLPDI.js")
		]);
...
async function createCallAgentScriptEntry(selfAppId) {
	try {
		const mod = await import("./call-agent-BWqYHQYt.js");
		return { "call-agent": {
			tool: mod.tool,
	...
	return {
		...
		"activate-browser": {
			...
			run: async (args) => {
				...
				const { requestBuilderBrowserConnection } = await import("./builder-browser-BYlUG2dF.js");
	...
	return { "agent-teams": {
		...
		run: async (args) => {
			...
			if (action === "spawn") {
				...
				const { spawnTask } = await import("./agent-teams-B0KudxKW.js");
			...
			if (action === "status") {
				...
				const { getTask } = await import("./agent-teams-B0KudxKW.js");
			...
			if (action === "send") {
				...
				const { sendToTask } = await import("./agent-teams-B0KudxKW.js");
				const result = await sendToTask(args.taskId, args.message);
				return JSON.stringify(result);
			}
			if (action === "list") {
				const { listTasks } = await import("./agent-teams-B0KudxKW.js");
...
async function loadResourcesForPrompt(owner, compact = false) {
	...
	const sections = [];
	try {
		const { loadAgentsBundle, generateSkillsPromptBlock } = await import("./agents-bundle-DNu5NvrE.js");
...
function createAgentChatPlugin(options) {
	return (nitroApp) => {
		...
		trackPluginInit(nitroApp, (async () => {
			const { awaitBootstrap } = await import("./framework-request-handler-UFrmVPec.js").then((n) => n.r);
			await awaitBootstrap(nitroApp);
			try {
			...
			let automationTools = {};
			try {
				const { createAutomationToolEntries } = await import("./actions-CSBMBQCg.js");
				automationTools = createAutomationToolEntries(() => requireCurrentRunOwner("manage automations"));
			} catch {}
			let notificationTools = {};
			try {
				const { createNotificationToolEntries } = await import("./actions-CEF1KbfL.js");
				notificationTools = createNotificationToolEntries(() => requireCurrentRunOwner("manage notifications"));
			} catch {}
			let progressTools = {};
			try {
				const { createProgressToolEntries } = await import("./actions-Bwoogogq.js");
			...
			const { mountA2A } = await import("./server-Dgq1T1hW.js");
			mountA2A(nitroApp, {
			...
			const { mountMCP } = await import("./server-BRZigPNI.js");
			mountMCP(nitroApp, {
				name: options?.appId ? options.appId.charAt(0).toUpperCase() + options.appId.slice(1) : "Agent",
				description: `Agent-native ${options?.appId ?? "app"} agent`,
				actions: allScripts,
			...
			if (Object.keys(httpActions).length > 0) {
				const { mountActionRoutes } = await import("./action-routes-CJJ1XNWC.js");
			...
			let jobTools = {};
			try {
				const { createJobTools } = await import("./tools-BlXqlzmu.js");
			...
			const prepareRun = async (event) => {
				...
				const { getOwnerActiveApiKey } = await import("./production-agent-Ciyfm6Lu.js");
...
Non-code requests are still fine on this surface — read data, navigate the UI, summarize, search, create/update extensions (sandboxed Alpine.js mini-apps stored in SQL), and call template actions. The restriction is specifically about editing the app's own source files.
			...
			getH3App(nitroApp).use(`${routePath}/mentions`, defineEventHandler(async (event) => {
				...
				async function mentionsStreamWork(controller) {
					...
					sources.push((async () => {
						try {
							const owner = await getOwnerFromEvent(event);
							const { listAccessibleCustomAgents } = await import("./agents-DIN3qWsZ.js");
			...
			try {
				const { processRecurringJobs } = await import("./scheduler-DxgV3tsb.js");
				const schedulerDeps = {
					getActions: () => ({
						...templateScripts,
						...resourceScripts,
			...
			try {
				const { initTriggerDispatcher } = await import("./dispatcher-DuVYIvd8.js");
...
async function enrichTreeNodes(nodes) {
	...
	let describeFn;
	try {
		const scheduler = await import("./scheduler-DxgV3tsb.js");
