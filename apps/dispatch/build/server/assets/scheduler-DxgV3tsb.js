...
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_bd141c93c3ba8c1834a821745ffc16c2/node_modules/@agent-native/core/dist/jobs/scheduler.js
var FRONTMATTER_RE = /^---\n([\s\S]*?)\n---\n?([\s\S]*)$/;
...
function subscribeToJobsResourceEvents() {
	...
	import("./emitter-BSyE4CDy.js").then((n) => n.r).then(({ getResourcesEmitter }) => {
...
async function processRecurringJobs(deps) {
	...
	try {
		...
		const { isConnectionError } = await import("./client-BnpqLOqs.js").then((n) => n.t);
