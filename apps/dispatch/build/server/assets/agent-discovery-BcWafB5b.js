...
async function discoverAgents(selfAppId) {
	...
	try {
		const { resourceList, resourceGet, SHARED_OWNER } = await import("./store-BokCrGTV.js");
...
//#endregion
export { loadWorkspaceAppsManifest as i, discoverAgents as n, findAgent as r, agent_discovery_exports as t };
