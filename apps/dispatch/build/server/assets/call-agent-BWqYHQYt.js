import { i as getRequestOrgId, o as getRequestUserEmail, r as getIntegrationRequestContext, s as isIntegrationCallerRequest } from "./request-context-Ci6C_Mch.js";
import { i as isLlmCredentialError, r as formatLlmCredentialErrorMessage } from "./credential-errors-CadDFEFG.js";
import { i as getOrgDomain, n as getOrgA2ASecret } from "./context-DeNWRFE0.js";
import { n as discoverAgents, r as findAgent } from "./agent-discovery-BcWafB5b.js";
import { t as A2A_CONTINUATION_QUEUED_MARKER } from "./a2a-continuation-marker-C7Y6JwmH.js";
import { a as signA2AToken, n as A2ATaskTimeoutError, r as callAgent, t as A2AClient } from "./client-1j91N6-z.js";
import { createHash } from "node:crypto";
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_bd141c93c3ba8c1834a821745ffc16c2/node_modules/@agent-native/core/dist/scripts/call-agent.js
...
async function enqueueIntegrationContinuationIfPossible(taskId, agent, message, ownerEmail) {
	...
	try {
		const [{ insertA2AContinuation }, { dispatchA2AContinuation }] = await Promise.all([import("./a2a-continuations-store-Cuqp4AHl.js"), import("./a2a-continuation-processor-D2PFdRvx.js")]);
...
async function formatExistingIntegrationContinuationIfRetry(agent, message) {
	...
	try {
		const { getA2AContinuationsForIntegrationTaskAgent } = await import("./a2a-continuations-store-Cuqp4AHl.js");
