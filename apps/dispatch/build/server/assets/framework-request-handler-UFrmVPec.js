...
async function bootstrapDefaultPlugins(nitroApp) {
	...
	try {
		...
		const serverModule = await import("./server-Djrw0kUO.js");
		const terminalModule = await import("./terminal-plugin-CkuTZgB5.js").then((n) => n.r);
		const integrationsModule = await import("./plugin-CHIlIYP-.js");
		const orgModule = await import("./plugin-DytOQvDC.js");
		const onboardingModule = await import("./plugin-D6FG9RW4.js");
