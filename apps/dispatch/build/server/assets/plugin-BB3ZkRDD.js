...
import { r as getSession, w as renderInviteEmail } from "./auth-CvO2kpTD.js";
...
import { a as markDefaultPluginProvided, i as getH3App, n as awaitBootstrap, t as FRAMEWORK_PREFIX } from "./framework-request-handler-UFrmVPec.js";
...
var syncA2ASecretHandler = defineEventHandler(async (event) => {
	...
	const { discoverAgents } = await import("./agent-discovery-BcWafB5b.js").then((n) => n.t);
