...
import { a as markDefaultPluginProvided, i as getH3App } from "./framework-request-handler-UFrmVPec.js";
import { createRequire } from "node:module";
import * as fs$1 from "node:fs";
import * as path$1 from "node:path";
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_bd141c93c3ba8c1834a821745ffc16c2/node_modules/@agent-native/core/dist/shared/runtime.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_bd141c93c3ba8c1834a821745ffc16c2/node_modules/@agent-native/core/dist/terminal/terminal-plugin.js
/**
...
(function fixSpawnHelperPermissions() {
	...
	try {
		...
		const ptyDir = path$1.dirname(ptyPkg);
		const helper = path$1.join(ptyDir, "prebuilds", `${process.platform}-${process.arch}`, "spawn-helper");
...
function createTerminalPlugin(options = {}) {
	return async (nitroApp) => {
		...
		getH3App(nitroApp).use("/_agent-native/available-clis", defineEventHandler(async () => {
			try {
				const { CLI_REGISTRY, commandExists } = await import("./cli-registry-BauUze_Z.js");
				const results = [];
		...
		try {
			const { createPtyWebSocketServer } = await import("./pty-server-N4osZqtx.js");
