...
//#region ../../node_modules/.pnpm/@agent-native+core@0.14.8_bd141c93c3ba8c1834a821745ffc16c2/node_modules/@agent-native/core/dist/server/credential-provider.js
/**
...
async function deleteBuilderCredentials(email, options) {
	const { deleteAppSecret } = await import("./storage-U0EZYB9K.js");
	const target = resolveCredentialWriteScope(email, options?.orgId ?? null, options?.role ?? null);
