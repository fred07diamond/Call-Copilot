...
import { S as track, T as readCorsAllowedOrigins, a as isDevEnvironment, p as getOrigin, r as getSession, w as getAllowedCorsOrigin, x as registerTrackingProvider } from "./auth-B6XASyqO.js";
...
import { a as listNotifications, i as deleteNotification, n as registerNotificationChannel, o as markAllNotificationsRead, r as countUnread, s as markNotificationRead } from "./registry-zJH4CK41.js";
import { n as resolveKeyReferences, r as validateUrlAllowlist, t as getKeyAllowlist } from "./substitution-Bjzwit72.js";
import { i as listRuns, n as getRun, t as deleteRun } from "./store-BdHAyw2F.js";
...
function createCoreRoutesPlugin(options = {}) {
	return async (nitroApp) => {
		...
		try {
			const { createObservabilityHandler } = await import("./routes-DeljCjMy.js");
		...
		getH3App(nitroApp).use(`${P}/builder/status`, defineEventHandler(async (event) => {
			...
			if (!ownerContext.anonymous) try {
				const { getOrgContext } = await import("./context-Bh-mBHiO.js");
		...
		try {
			...
			const { createExtensionsHandler } = await import("./routes-DdI0O1JJ.js");
			...
			const { createSlotsHandler } = await import("./routes-DkC0vN-Z.js");
		...
		getH3App(nitroApp).use(`${P}/automations`, defineEventHandler(async (event) => {
			...
			try {
				...
				const { resourceListAllOwners, SHARED_OWNER } = await import("./store-C4t59_TO.js");
...
async function signFreshContinuationToken(continuation) {
	...
	if (continuation.orgId) try {
		const { getOrgDomain, getOrgA2ASecret } = await import("./context-Bh-mBHiO.js");
